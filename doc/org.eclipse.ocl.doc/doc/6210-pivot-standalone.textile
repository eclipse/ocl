...
org.eclipse.ocl.examples.pivot.uml.UML2AS.initialize(resourceSet);
...
@org.eclipse.ocl.examples.pivot.uml.UML2AS.initialize(ResourceSet)@ as well. 
...
If you want to use the default OCL Standard Library you should invoke @org.eclipse.ocl.examples.pivot.model.OCLstdlib.install()@ which installs a compiled shareable form of @/org.eclipse.ocl.library/model/OCL-2.5.oclstdlib@.
  ...
  org.eclipse.ocl.examples.markup
    org.eclipse.ocl.examples.markup.ui
      org.eclipse.ocl.xtext.essentialocl.ui
        ...
        org.eclipse.ocl.examples.console
p. 
