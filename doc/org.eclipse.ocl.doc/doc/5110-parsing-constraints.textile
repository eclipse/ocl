...
The OCL parser provides two APIs for parsing constraint and query expressions. The "@OCLHelper@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/helper/OCLHelper.html interface is designed primarily for parsing constraints and query expressions
embedded in models, such as Ecore or UML models.  The "@OCL@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/OCL.html class serves as the main entrypoint into the parsing API but also implements the
...
The "@OCL@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/OCL.html class is a generic type; its type parameters represent the various metaclasses
...
"@Environment@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/Environment.html created by an
"@EnvironmentFactory@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/EnvironmentFactory.html 
...
"@Variable@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/expressions/Variable.html s
...
"@OCLHelper@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/helper/OCLHelper.html 
stores all of the instantiations of OCL template metaclasses (such as
"@CollectionType(T)@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/types/CollectionType.html 
and "@TupleType@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/types/TupleType.html 
...
"@OCLExpression@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/expressions/OCLExpression.html,
