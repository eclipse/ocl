...
Again within the Ecore editor use *OCL->Show Validity View* to see the constraints/element pairs. (If the Validity View was already visible, close it and re-show it since in Luna addition of a Complete OCL document fails to refresh correctly.)
...
!{width:90%}images/4500-complete-ocl-debugger-model.png(CompleteOCLDebuggerImage)!
