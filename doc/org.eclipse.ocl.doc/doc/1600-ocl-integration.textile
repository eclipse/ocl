...
!{width:45%}images/1600-load-document.png(LoadDocument)!
...
The *org.eclipse.ocl.examples.pivot.complete_ocl_registry* may be used to register Complete OCL files against the nsURIs that they complement. These extension points may be defined in plugins or projects.
