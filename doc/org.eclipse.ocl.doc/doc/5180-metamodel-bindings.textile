...
The "@Environment@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/Environment.html interface has a generic type signature with several parameters, representing the metamodeling
