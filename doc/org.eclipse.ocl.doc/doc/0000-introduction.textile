...
A PDF version of this documentation is available at "OCL 5.0.0 Documentation":http://download.eclipse.org/ocl/doc/5.0.0/ocl.pdf.
...
Full model-driven extensibility is planned for the Mars release.
...
Direct tooling of the UML 2.5 and OCL 2.5 specifications for the Mars Eclipse release may demonstrate that the OCL aspects of the specifications is also functionally consistent.
