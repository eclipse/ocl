...
p. 
The "@OCLHelper@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/helper/OCLHelper.html API provides support for content-assist in rich editors, by parsing partial OCL
...
The "@Choice@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/helper/Choice.html objects returned by the helper include some convenient text strings (name and
