...
The OCL parser provides two APIs for parsing constraint and query expressions. The "@OCLHelper@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/helper/OCLHelper.html interface is designed primarily for parsing constraints and query expressions
embedded in models, such as Ecore or UML models.  The "@OCL@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/OCL.html class serves as the main entrypoint into the parsing API but also implements the
...
The "@OCL@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/OCL.html class is a simple type.
...
"@PivotEnvironmentFactory@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/utilities/PivotEnvironmentFactory.html.

An OCL parsing activity maintains the root and nested parsing context in
"@Environment@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/Environment.html
instances which are created by an
"@EnvironmentFactory@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/EnvironmentFactory.html.
...
"@Variable@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/examples/pivot/Variable.html s
...
"@ExpressionInOCL@":http://download.eclipse.org/ocl/javadoc/6.0.0/org/eclipse/ocl/expressions/ExpressionInOCL.html,
