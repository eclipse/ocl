...
"@EvaluationVisitor@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/EvaluationVisitor.html for evaluating OCL expressions.

h3. Implementing a Visitor

The best way to implement a visitor is to extend the
"@AbstractVisitor@":http://download.eclipse.org/ocl/javadoc/5.0.0/org/eclipse/ocl/utilities/AbstractVisitor.html class.  It provides a @result@ variable of the generic
