...
!{width:60%}images/4600-validation-view-model-elements.png(ValidationViewModelElements)!

The right hand pane shows the root metamodel constraint sources.

!{width:60%}images/4600-validation-view-metamodel-constraints.png(ValidationViewMetamodelConstraints)!
...
!cimages/4600-validation-view-results-context.png(ValidationViewResultsContext)!
