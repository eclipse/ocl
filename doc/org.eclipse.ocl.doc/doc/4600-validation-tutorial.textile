...
The *basecs in http://www.eclipse.org/ocl/2015/BaseCS* root constraint similarly contributing 2 successes without problem, so we ignore it as well by unchecking the enable checkbox preceding it.
