...
public class EmployeeImpl extends EObjectImpl implements Employee {
	...
	public EList<Employee> getDirectReports() {
		...
		final List<Employee> UNBOXED_select = select.asEcoreObjects(idResolver, Employee.class);
	...
	public EList<Employee> getAllReports() {
		...
		final @NonNull /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE.evaluate(evaluator, CodegencompanyTables.SET_CLSSid_Employee, TYP_company_c_c_Employee_0);
	...
	public EList<Employee> getReportingChain() {
		...
		final List<Employee> UNBOXED_symbol_8 = symbol_8.asEcoreObjects(idResolver, Employee.class);
	...
	public boolean noManagerImpliesDirectReports(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final @NonNull /*@NonInvalid*/ Evaluator evaluator = PivotUtilInternal.getEvaluator(this);
		final @NonNull /*@NonInvalid*/ IdResolver idResolver = evaluator.getIdResolver();
		final @NonNull /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, CodegencompanyTables.STR_Employee_c_c_noManagerImpliesDirectReports);
		...
		if (le) {
		    ...
		    try {
		        ...
		        try {
		            ...
		            final /*@Thrown*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(evaluator, size, CodegencompanyTables.INT_0).booleanValue();
		            CAUGHT_gt = gt;
		        }
		        catch (Exception e) {
	...
	public boolean mustHaveName(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 */
		final @NonNull /*@NonInvalid*/ Evaluator evaluator = PivotUtilInternal.getEvaluator(this);
		final @NonNull /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, CodegencompanyTables.STR_Employee_c_c_mustHaveName);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(evaluator, severity_0, CodegencompanyTables.INT_0).booleanValue();
		/*@NonInvalid*/ boolean symbol_1;
		if (le) {
		    symbol_1 = ValueUtil.TRUE_VALUE;
	...
	public boolean mustHaveNonEmptyName(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 */
		final @NonNull /*@NonInvalid*/ Evaluator evaluator = PivotUtilInternal.getEvaluator(this);
		final @NonNull /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, CodegencompanyTables.STR_Employee_c_c_mustHaveNonEmptyName);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(evaluator, severity_0, CodegencompanyTables.INT_0).booleanValue();
