...
public interface Employee extends EObject {
	 ...
	 * <!-- end-user-doc -->
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/**\n * self.reportingChain->includes(manager)\n \052/\nfinal @<%org.eclipse.jdt.annotation.NonNull%> /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.DomainEvaluator%> evaluator = <%org.eclipse.ocl.pivot.utilities.PivotUtil%>.getEvaluator(this);\nfinal @<%org.eclipse.jdt.annotation.NonNull%> /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = evaluator.getIdResolver();\nfinal @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%java.util.List%><<%codegen.company.Employee%>> reportingChain = this.getReportingChain();\nfinal @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_reportingChain = idResolver.createOrderedSetOfAll(<%codegen.company.CodegencompanyTables%>.ORD_CLSSid_Employee, reportingChain);\nfinal /*@Thrown\052/ boolean includes = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.collection.CollectionIncludesOperation%>.INSTANCE.evaluate(BOXED_reportingChain, manager).booleanValue());\nreturn includes;'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/**\n * \n * inv noManagerImpliesDirectReports:\n *   manager.oclIsUndefined() implies\n *   directReports->size() > 0\n \052/\n@<%org.eclipse.jdt.annotation.NonNull%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_symbol_9;\ntry {\n    @<%org.eclipse.jdt.annotation.Nullable%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_manager_0;\n    try {\n        final @<%org.eclipse.jdt.annotation.Nullable%> /*@Thrown\052/ <%codegen.company.Employee%> manager_0 = this.getManager();\n        CAUGHT_manager_0 = manager_0;\n    }\n    catch (<%java.lang.Exception%> e) {\n        CAUGHT_manager_0 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n    }\n    final /*@NonInvalid\052/ boolean self_11 = (CAUGHT_manager_0 == null) || (CAUGHT_manager_0 instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>);\n    final @<%org.eclipse.jdt.annotation.NonNull%> /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.DomainEvaluator%> evaluator = <%org.eclipse.ocl.pivot.utilities.PivotUtil%>.getEvaluator(this);\n    final @<%org.eclipse.jdt.annotation.NonNull%> /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = evaluator.getIdResolver();\n    @<%org.eclipse.jdt.annotation.NonNull%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_b;\n    try {\n        final @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%java.util.List%><<%codegen.company.Employee%>> directReports = this.getDirectReports();\n        final @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_directReports = idResolver.createOrderedSetOfAll(<%codegen.company.CodegencompanyTables%>.ORD_CLSSid_Employee, directReports);\n        final @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.collection.CollectionSizeOperation%>.INSTANCE.evaluate(BOXED_directReports));\n        final /*@Thrown\052/ boolean b = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.oclany.OclComparableGreaterThanOperation%>.INSTANCE.evaluate(evaluator, size, <%codegen.company.CodegencompanyTables%>.INT_0).booleanValue());\n        CAUGHT_b = b;\n    }\n    catch (<%java.lang.Exception%> e) {\n        CAUGHT_b = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n    }\n    final /*@NonInvalid\052/ boolean eq = !self_11;\n    /*@Thrown\052/ boolean symbol_9;\n    if (eq) {\n        symbol_9 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n    }\n    else {\n        final /*@NonInvalid\052/ boolean symbol_6 = CAUGHT_b instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>;\n        /*@Thrown\052/ boolean symbol_8;\n        if (symbol_6) {\n            if (CAUGHT_b instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n                throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_b;\n            }\n            symbol_8 = (<%java.lang.Boolean%>)CAUGHT_b;\n        }\n        else {\n            /*@NonInvalid\052/ boolean symbol_7;\n            if (CAUGHT_b == Boolean.TRUE) {\n                symbol_7 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n            }\n            else {\n                symbol_7 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.FALSE_VALUE;\n            }\n            symbol_8 = symbol_7;\n        }\n        symbol_9 = symbol_8;\n    }\n    CAUGHT_symbol_9 = symbol_9;\n}\ncatch (<%java.lang.Exception%> e) {\n    CAUGHT_symbol_9 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n}\nif (CAUGHT_symbol_9 == <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE) {\n    return true;\n}\nif (diagnostics != null) {\n    int severity = <%org.eclipse.emf.common.util.Diagnostic%>.WARNING;\n    <%java.lang.String%> message = <%org.eclipse.osgi.util.NLS%>.bind(<%org.eclipse.ocl.pivot.messages.EvaluatorMessages%>.ValidationConstraintIsNotSatisfied_ERROR_, new Object[]{\"Employee\", \"noManagerImpliesDirectReports\", <%org.eclipse.emf.ecore.util.EObjectValidator%>.getObjectLabel(this, context)});\n    diagnostics.add(new <%org.eclipse.emf.common.util.BasicDiagnostic%>(severity, <%codegen.company.util.CodegencompanyValidator%>.DIAGNOSTIC_SOURCE, <%codegen.company.util.CodegencompanyValidator%>.EMPLOYEE__NO_MANAGER_IMPLIES_DIRECT_REPORTS, message, new Object [] { this }));\n}\nreturn false;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='/**\n * \n * inv mustHaveNonEmptyName: name->notEmpty() implies name.size() > 0\n \052/\nfinal @<%org.eclipse.jdt.annotation.NonNull%> /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.DomainEvaluator%> evaluator = <%org.eclipse.ocl.pivot.utilities.PivotUtil%>.getEvaluator(this);\n@<%org.eclipse.jdt.annotation.NonNull%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_symbol_14;\ntry {\n    @<%org.eclipse.jdt.annotation.NonNull%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_self_11;\n    try {\n        final @<%org.eclipse.jdt.annotation.Nullable%> /*@Thrown\052/ <%java.lang.String%> name = this.getName();\n        final @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SetValue%> oclAsSet = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.oclany.OclAnyOclAsSetOperation%>.INSTANCE.evaluate(evaluator, <%codegen.company.CodegencompanyTables%>.SET_PRIMid_String, name));\n        final /*@Thrown\052/ boolean self_11 = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.collection.CollectionNotEmptyOperation%>.INSTANCE.evaluate(oclAsSet).booleanValue());\n        CAUGHT_self_11 = self_11;\n    }\n    catch (<%java.lang.Exception%> e) {\n        CAUGHT_self_11 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n    }\n    @<%org.eclipse.jdt.annotation.NonNull%> /*@Caught\052/ <%java.lang.Object%> CAUGHT_b;\n    try {\n        final @<%org.eclipse.jdt.annotation.Nullable%> /*@Thrown\052/ <%java.lang.String%> name_0 = this.getName();\n        final @<%org.eclipse.jdt.annotation.NonNull%> /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.string.StringSizeOperation%>.INSTANCE.evaluate(name_0));\n        final /*@Thrown\052/ boolean b = <%org.eclipse.ocl.pivot.utilities.ClassUtil%>.nonNullState(<%org.eclipse.ocl.library.oclany.OclComparableGreaterThanOperation%>.INSTANCE.evaluate(evaluator, size, <%codegen.company.CodegencompanyTables%>.INT_0).booleanValue());\n        CAUGHT_b = b;\n    }\n    catch (<%java.lang.Exception%> e) {\n        CAUGHT_b = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n    }\n    final /*@NonInvalid\052/ boolean symbol_6 = CAUGHT_self_11 instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>;\n    /*@Thrown\052/ boolean symbol_14;\n    if (symbol_6) {\n        final /*@NonInvalid\052/ boolean symbol_7 = CAUGHT_b instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>;\n        /*@Thrown\052/ boolean symbol_9;\n        if (symbol_7) {\n            if (CAUGHT_self_11 instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n                throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_self_11;\n            }\n            symbol_9 = (<%java.lang.Boolean%>)CAUGHT_self_11;\n        }\n        else {\n            /*@Thrown\052/ boolean symbol_8;\n            if (CAUGHT_b == Boolean.TRUE) {\n                symbol_8 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n            }\n            else {\n                if (CAUGHT_self_11 instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n                    throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_self_11;\n                }\n                symbol_8 = (<%java.lang.Boolean%>)CAUGHT_self_11;\n            }\n            symbol_9 = symbol_8;\n        }\n        symbol_14 = symbol_9;\n    }\n    else {\n        if (CAUGHT_self_11 instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n            throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_self_11;\n        }\n        final /*@Thrown\052/ boolean eq = CAUGHT_self_11 == Boolean.FALSE;\n        /*@Thrown\052/ boolean symbol_13;\n        if (eq) {\n            symbol_13 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n        }\n        else {\n            final /*@NonInvalid\052/ boolean symbol_10 = CAUGHT_b instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>;\n            /*@Thrown\052/ boolean symbol_12;\n            if (symbol_10) {\n                if (CAUGHT_b instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n                    throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_b;\n                }\n                symbol_12 = (<%java.lang.Boolean%>)CAUGHT_b;\n            }\n            else {\n                /*@NonInvalid\052/ boolean symbol_11;\n                if (CAUGHT_b == Boolean.TRUE) {\n                    symbol_11 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n                }\n                else {\n                    symbol_11 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.FALSE_VALUE;\n                }\n                symbol_12 = symbol_11;\n            }\n            symbol_13 = symbol_12;\n        }\n        symbol_14 = symbol_13;\n    }\n    CAUGHT_symbol_14 = symbol_14;\n}\ncatch (<%java.lang.Exception%> e) {\n    CAUGHT_symbol_14 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n}\nif (CAUGHT_symbol_14 == <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE) {\n    return true;\n}\nif (diagnostics != null) {\n    int severity = <%org.eclipse.emf.common.util.Diagnostic%>.WARNING;\n    <%java.lang.String%> message = <%org.eclipse.osgi.util.NLS%>.bind(<%org.eclipse.ocl.pivot.messages.EvaluatorMessages%>.ValidationConstraintIsNotSatisfied_ERROR_, new Object[]{\"Employee\", \"mustHaveNonEmptyName\", <%org.eclipse.emf.ecore.util.EObjectValidator%>.getObjectLabel(this, context)});\n    diagnostics.add(new <%org.eclipse.emf.common.util.BasicDiagnostic%>(severity, <%codegen.company.util.CodegencompanyValidator%>.DIAGNOSTIC_SOURCE, <%codegen.company.util.CodegencompanyValidator%>.EMPLOYEE__MUST_HAVE_NON_EMPTY_NAME, message, new Object [] { this }));\n}\nreturn false;'"
	 * @generated
	 */
