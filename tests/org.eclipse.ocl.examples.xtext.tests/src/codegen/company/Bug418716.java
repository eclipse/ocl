...
public interface Bug418716 extends EObject {
	 ...
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * 100\n \052/\nfinal @<%org.eclipse.jdt.annotation.Nullable%> /*@NonInvalid\052/ <%java.lang.Object%> UNBOXED_INT_100 = <%codegen.company.CodegencompanyTables%>.INT_100.asNumber();\nreturn ((<%java.lang.Number%>)UNBOXED_INT_100).intValue();'"
	 * @generated
	 */
