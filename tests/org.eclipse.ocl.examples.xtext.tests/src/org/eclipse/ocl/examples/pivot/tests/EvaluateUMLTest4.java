...
//		assertEquals(IdManager.METAMODEL, contextPackage.getPackageId());
		...
		assertSemanticErrorQuery2((Type)contextType, "self.extension_Stereotype1", OCLMessages.UnresolvedProperty_ERROR_, "UML::Property", "extension_Stereotype1");	
		assertValidQuery((Type)contextType, "self.extension_vStereotype1.base_NamedElement");	
		assertSemanticErrorQuery2((Type)contextType, "self.extension_vStereotype1.base_Class", OCLMessages.UnresolvedProperty_ERROR_, "Bug431638Profile::vStereotype1", "base_Class");	
		assertSemanticErrorQuery2((Type)contextType, "self.extension_vStereotype1.string", OCLMessages.UnresolvedProperty_ERROR_, "Bug431638Profile::vStereotype1", "string");	
...
//		assertQueryTrue(context, "self.oclType().oclIsKindOf(self.extension_vStereotype1.base_NamedElement)");	
		assertSemanticErrorQuery2((Type)contextType, "self.extension_vStereotype1.base_Class = self.oclType()", OCLMessages.UnresolvedProperty_ERROR_, "Bug431638Profile::vStereotype1", "base_Class");	
