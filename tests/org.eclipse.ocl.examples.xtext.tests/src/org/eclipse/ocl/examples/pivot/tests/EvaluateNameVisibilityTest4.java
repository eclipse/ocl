...
//			OCLDelegateDomain.initialize(null);
		...
		org.eclipse.ocl.pivot.Package pivotPackage = pivotModel.getOwnedPackages().get(0);
		org.eclipse.ocl.pivot.Class pivotType = pivotPackage.getOwnedClasses().get(0);
		EClass eClass = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, ClassUtil.nonNullState(pivotType)));
		Object testObject = eClass.getEPackage().getEFactoryInstance().create(eClass);
...
//			OCLDelegateDomain.initialize(null);
		...
		EClass eClassA = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeA));
		EClass eClassB = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeB));
...
//		greenApple.eSet(fruit_color, color_green);
		...
		ocl.assertQueryEquals(aTree, TestUtil.createOrderedSetOfEach(idResolver, redApple), "let aTree : fruit::Tree = self in aTree.fruits");
		ocl.assertQueryEquals(aTree, TestUtil.createOrderedSetOfEach(idResolver, redApple), "self.fruits");
		ocl.assertQueryEquals(aTree, TestUtil.createOrderedSetOfEach(idResolver, redApple), "fruits");
...
//		
		...
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, redApple), "self->oclAsType(Set(Fruit))");
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, redApple), "self->oclAsType(Set(fruit::Apple))");
		...
		//
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, appleTree), "Tree.allInstances()");
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, appleTree), "fruit::Tree.allInstances()");
...
//
		...
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, appleTree), "zz::Tree.allInstances()");
//
		ocl.assertQueryEquals(redApple, TestUtil.createBagOfEach(idResolver, redApple), "Fruit.allInstances().oclAsType(Apple)");		
		ocl.assertQueryEquals(redApple, TestUtil.createSetOfEach(idResolver, redApple), "Fruit.allInstances()->oclAsType(Set(Apple))");		
        ocl.dispose();
	}
...
//		org.eclipse.ocl.pivot.Class pivotTypeT1 = ClassUtil.getNamedElement(pivotPackage.getOwnedType(), "T1");
		...
		EPackage ePackage = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EPackage.class, pivotPackage));
		EClass eClassDomain = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeDomain));
//		EClass eClassT1 = metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT1);
		EClass eClassT2a = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT2a));
		EClass eClassT2b = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT2b));
		EClass eClassT3a = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT3a));
		EClass eClassT3b = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT3b));
		EClass eClassT4 = ClassUtil.nonNullState(metamodelManager.getEcoreOfPivot(EClass.class, pivotTypeT4));
