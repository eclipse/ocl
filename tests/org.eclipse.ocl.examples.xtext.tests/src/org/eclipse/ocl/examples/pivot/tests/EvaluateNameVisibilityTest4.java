...
/*	@Test public void test_cg_derived_operation() throws ParserException, IOException {
	...
	@Test public void test_cg_name_occlusion_401692() throws ParserException, IOException {
		...
		Model pivotModel = (Model) metaModel.getContents().get(0);
		org.eclipse.ocl.pivot.Package pivotPackage = pivotModel.getOwnedPackages().get(0);
		org.eclipse.ocl.pivot.Class pivotTypeA = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "A");
		org.eclipse.ocl.pivot.Class pivotTypeB = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "B");
		...
		EAttribute eAttributeAd = metaModelManager.getEcoreOfPivot(EAttribute.class, DomainUtil.getNamedElement(pivotTypeA.getOwnedProperties(), "d"));
		EAttribute eAttributeAe = metaModelManager.getEcoreOfPivot(EAttribute.class, DomainUtil.getNamedElement(pivotTypeA.getOwnedProperties(), "e"));
		EReference eReferenceBas = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeB.getOwnedProperties(), "as"));
...
//
	...
	@Test public void test_uml_primitives_399378() throws ParserException {
		...
		org.eclipse.ocl.pivot.Class treeClass = DomainUtil.getNamedElement(fruitPackage.getOwnedClasses(), "Tree");
	...
	@Test public void test_dynamic_dispatch_411154() throws ParserException, IOException {
		...
		Model pivotModel = (Model) metaModel.getContents().get(0);
		org.eclipse.ocl.pivot.Package pivotPackage = pivotModel.getOwnedPackages().get(0);
		org.eclipse.ocl.pivot.Class pivotTypeDomain = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "Domain");
//		org.eclipse.ocl.pivot.Class pivotTypeT1 = DomainUtil.getNamedElement(pivotPackage.getOwnedType(), "T1");
		org.eclipse.ocl.pivot.Class pivotTypeT2a = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "T2a");
		org.eclipse.ocl.pivot.Class pivotTypeT2b = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "T2b");
		org.eclipse.ocl.pivot.Class pivotTypeT3a = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "T3a");
		org.eclipse.ocl.pivot.Class pivotTypeT3b = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "T3b");
		org.eclipse.ocl.pivot.Class pivotTypeT4 = DomainUtil.getNamedElement(pivotPackage.getOwnedClasses(), "T4");
		EPackage ePackage = metaModelManager.getEcoreOfPivot(EPackage.class, pivotPackage);
...
//		EClass eClassT1 = metaModelManager.getEcoreOfPivot(EClass.class, pivotTypeT1);
		...
		EReference eReferenceDomain_types = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "types"));
		EReference eReferenceDomain_t1_2a = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t1_2a"));
		EReference eReferenceDomain_t1_3a = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t1_3a"));
		EReference eReferenceDomain_t1_3b = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t1_3b"));
		EReference eReferenceDomain_t1_4 = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t1_4"));
		EReference eReferenceDomain_t2a_2a = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t2a_2a"));
		EReference eReferenceDomain_t2a_3a = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t2a_3a"));
		EReference eReferenceDomain_t2b_2b = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t2b_2b"));
		EReference eReferenceDomain_t3a = metaModelManager.getEcoreOfPivot(EReference.class, DomainUtil.getNamedElement(pivotTypeDomain.getOwnedProperties(), "t3a"));
		EFactory eFactory = ePackage.getEFactoryInstance();
		Resource resource = new ResourceImpl();
