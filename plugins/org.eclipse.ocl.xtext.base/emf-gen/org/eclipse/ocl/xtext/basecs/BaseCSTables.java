...
public class BaseCSTables
{
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_PRIMid_String = TypeId.ORDERED_SET.getSpecializedId(TypeId.STRING, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId SEQ_PRIMid_String = TypeId.SEQUENCE.getSpecializedId(TypeId.STRING, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_ElementCS = TypeId.BAG.getSpecializedId(BaseCSTables.CLSSid_ElementCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_AnnotationElementCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_AnnotationElementCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ClassCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ClassCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ConstraintCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ConstraintCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_DetailCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_DetailCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_EnumerationLiteralCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_EnumerationLiteralCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ImportCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ImportCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ModelElementCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ModelElementCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ModelElementRefCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ModelElementRefCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_OperationCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_OperationCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_PackageCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_PackageCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ParameterCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_ParameterCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_PathElementCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_PathElementCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Property = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_Property, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_SpecificationCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_SpecificationCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_StructuralFeatureCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_StructuralFeatureCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TemplateParameterCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_TemplateParameterCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TemplateParameterSubstitutionCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_TemplateParameterSubstitutionCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TuplePartCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_TuplePartCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TypedRefCS = TypeId.ORDERED_SET.getSpecializedId(BaseCSTables.CLSSid_TypedRefCS, TypeId.BOOLEAN, TypeId.INTEGER, TypeId.UNLIMITED_NATURAL);
