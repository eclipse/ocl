...
ruleTypedMultiplicityRefCS returns [EObject current=null] 
    ...
    { 
        newCompositeNode(grammarAccess.getTypedMultiplicityRefCSAccess().getTypedRefCSParserRuleCall()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypedTypeRefCSAccess().getOwnedMultiplicityMultiplicityCSParserRuleCall_2_0()); 
	    }
		lv_ownedMultiplicity_7_0=ruleMultiplicityCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypedTypeRefCSRule());
	        }
       		set(
