...
(
		{ 
	        newCompositeNode(grammarAccess.getAttributeCSAccess().getOwnedTypeFullTypeDeclarationCSParserRuleCall_3_1_0()); 
	    }
...
(
		...
		lv_ownedDerivedConstraints_36_0=ruleDerivationConstraintCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAttributeCSRule());
	        }
       		add(
        		...
        		lv_ownedDerivedConstraints_36_0, 
    ...
    {
    	newLeafNode(otherlv_37, grammarAccess.getAttributeCSAccess().getRightCurlyBracketKeyword_6_0_2());
    }
)
    |	otherlv_38=';' 
    {
    	newLeafNode(otherlv_38, grammarAccess.getAttributeCSAccess().getSemicolonKeyword_6_1());
    }
))
;
...
entryRuleDerivationConstraintCS returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDerivationConstraintCSRule()); }
	 iv_ruleDerivationConstraintCS=ruleDerivationConstraintCS 
	 { $current=$iv_ruleDerivationConstraintCS.current; } 
	 EOF 
;

// Rule DerivationConstraintCS
ruleDerivationConstraintCS returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationCSAccess().getOwnedTypeFullTypeDeclarationCSParserRuleCall_7_1_0()); 
	    }
		lv_ownedType_13_0=ruleFullTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOperationCSRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationCSAccess().getOwnedExceptionsSimpleTypeDeclarationCSParserRuleCall_8_1_0()); 
	    }
		lv_ownedExceptions_15_0=ruleSimpleTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOperationCSRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationCSAccess().getOwnedExceptionsSimpleTypeDeclarationCSParserRuleCall_8_2_1_0()); 
	    }
		lv_ownedExceptions_17_0=ruleSimpleTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOperationCSRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getParameterCSAccess().getOwnedTypeFullTypeDeclarationCSParserRuleCall_1_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getReferenceCSAccess().getOwnedTypeFullTypeDeclarationCSParserRuleCall_4_1_0()); 
	    }
		lv_ownedType_9_0=ruleFullTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReferenceCSRule());
	        }
       		set(
...
(
		...
		lv_ownedDerivedConstraints_45_0=ruleDerivationConstraintCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReferenceCSRule());
	        }
       		add(
       			$current, 
       			"ownedDerivedConstraints",
        		lv_ownedDerivedConstraints_45_0, 
        		"DerivationConstraintCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_46, grammarAccess.getReferenceCSAccess().getRightCurlyBracketKeyword_7_0_2());
    }
)
    |	otherlv_47=';' 
    {
    	newLeafNode(otherlv_47, grammarAccess.getReferenceCSAccess().getSemicolonKeyword_7_1());
    }
))
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getStructuredClassCSAccess().getOwnedSuperTypesSimpleTypeDeclarationCSParserRuleCall_4_1_0()); 
	    }
		lv_ownedSuperTypes_5_0=ruleSimpleTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getStructuredClassCSRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getStructuredClassCSAccess().getOwnedSuperTypesSimpleTypeDeclarationCSParserRuleCall_4_2_1_0()); 
	    }
		lv_ownedSuperTypes_7_0=ruleSimpleTypeDeclarationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getStructuredClassCSRule());
	        }
       		add(
