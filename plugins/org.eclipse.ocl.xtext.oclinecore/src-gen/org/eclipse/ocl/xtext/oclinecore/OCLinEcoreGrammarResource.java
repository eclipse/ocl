...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_OCLinEcore.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Tuple")));
