...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLinEcore
	{
		...
		private static void initParserRules() {
			...
			PR_TypedMultiplicityRefCS.setAlternatives(createRuleCall(PR_TypedRefCS));
			...
			PR_TypedTypeRefCS.setAlternatives(createGroup(createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("?", createAlternatives(createGroup(createKeyword("("), createAssignment("ownedBinding", "=", createRuleCall(_Base.PR_TemplateBindingCS)), createKeyword(")")), createGroup(createKeyword("<"), createAssignment("ownedBinding", "=", createRuleCall(_Base.PR_TemplateBindingCS)), createKeyword(">")))), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
