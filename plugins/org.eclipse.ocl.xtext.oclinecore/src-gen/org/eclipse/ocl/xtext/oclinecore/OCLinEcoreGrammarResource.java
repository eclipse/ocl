...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLinEcore
	{
		...
		private static final @NonNull ParserRule PR_DerivationConstraintCS = createParserRule("DerivationConstraintCS", createTypeRef(MM, org.eclipse.ocl.xtext.oclinecorecs.OCLinEcoreCSPackage.Literals.OC_LIN_ECORE_CONSTRAINT_CS));
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_DerivationConstraintCS);
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CollectionTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_CollectionTypeIdentifier)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS)), createKeyword(")")))));
			...
			PR_LambdaParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS))));
			...
			PR_MapTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Map")), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedKeyType", "=", createRuleCall(PR_FullTypeDeclarationCS)), createKeyword(","), createAssignment("ownedValueType", "=", createRuleCall(PR_FullTypeDeclarationCS)), createKeyword(")")))));
			...
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS))))))));
