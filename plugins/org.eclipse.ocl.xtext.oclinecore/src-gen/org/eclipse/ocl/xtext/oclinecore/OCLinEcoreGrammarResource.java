...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_LambdaParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
