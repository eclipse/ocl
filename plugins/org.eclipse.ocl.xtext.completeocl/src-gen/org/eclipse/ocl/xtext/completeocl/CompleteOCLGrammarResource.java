...
public class CompleteOCLGrammarResource extends AbstractGrammarResource
{
	...
	private static class _CompleteOCL
	{
		...
		private static void initParserRules() {
			PR_ClassifierContextDeclCS.setAlternatives(createGroup(createKeyword("context"), setCardinality("?", createAssignment("selfName", "=", createRuleCall(PR_UnrestrictedName))), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), setCardinality("+", createAlternatives(createGroup(createKeyword("inv"), createAssignment("ownedInvariants", "+=", createRuleCall(PR_ConstraintCS))), createAssignment("ownedDefinitions", "+=", createRuleCall(PR_DefCS))))));
			...
			PR_OperationContextDeclCS.setAlternatives(createGroup(createKeyword("context"), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)))))), createKeyword(")"), createKeyword(":"), setCardinality("?", createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_FullTypeDeclarationCS))), setCardinality("*", createAlternatives(createGroup(createKeyword("pre"), createAssignment("ownedPreconditions", "+=", createRuleCall(PR_ConstraintCS))), createGroup(createKeyword("post"), createAssignment("ownedPostconditions", "+=", createRuleCall(PR_ConstraintCS))), createGroup(createKeyword("body"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedBodies", "+=", createRuleCall(PR_SpecificationCS)))))));
			...
			PR_ParameterCS.setAlternatives(createGroup(setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"))), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_FullTypeDeclarationCS))));
			...
			PR_PropertyContextDeclCS.setAlternatives(createGroup(createKeyword("context"), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_FullTypeDeclarationCS)), setCardinality("*", createAlternatives(createGroup(createKeyword("derive"), createAssignment("ownedDerivedInvariants", "+=", createRuleCall(PR_ConstraintCS))), createGroup(createKeyword("init"), createKeyword(":"), createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_SpecificationCS)))))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS))))))));
