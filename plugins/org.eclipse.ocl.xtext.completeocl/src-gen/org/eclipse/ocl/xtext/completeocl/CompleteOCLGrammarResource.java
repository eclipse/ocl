...
public class CompleteOCLGrammarResource extends AbstractGrammarResource
{
	...
	private static class _CompleteOCL
	{
		...
		private static void initParserRules() {
			...
			PR_ParameterCS.setAlternatives(createGroup(setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"))), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_ComplexTypeCS))));
			...
			PR_PropertyContextDeclCS.setAlternatives(createGroup(createKeyword("context"), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_ComplexTypeCS)), setCardinality("*", createAlternatives(createGroup(createKeyword("derive"), createAssignment("ownedDerivedInvariants", "+=", createRuleCall(PR_ConstraintCS))), createGroup(createKeyword("init"), createKeyword(":"), createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_SpecificationCS)))))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_LambdaParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeCS))))))));
