...
public class CompleteOCLGrammarResource extends AbstractGrammarResource
{
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_CompleteOCL.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(_CompleteOCL.PR_PrimitiveTypeIdentifier), createKeyword("Tuple")));
