...
public class WizardNewCompleteOCLFileCreation
	...
	private WizardNewCompleteOCLFileCreationPage page;
	...
	public WizardNewCompleteOCLFileCreation() {
		super();
		setWindowTitle(EcoreAndUMLUIMessages.WizardNewCompleteOCLFileCreationPage_newCompleteOCLFile);
		setDefaultPageImageDescriptor(Activator
			.getImageDescriptor(EcoreAndUMLUIMessages.WizardNewCompleteOCLFileCreationPage_OCLModelFileIcon));
	}
