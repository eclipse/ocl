 ...
 *******************************************************************************/
package org.eclipse.ocl.pivot.compatibility;
...
public class UML_4_2
{
	...
	static {
		...
		try {
			Class<?> uml2EcoreConverterClass = CommonPlugin.loadClass("org.eclipse.ocl.pivot.internal","org.eclipse.uml2.uml.util.UMLUtil$UML2EcoreConverter");
