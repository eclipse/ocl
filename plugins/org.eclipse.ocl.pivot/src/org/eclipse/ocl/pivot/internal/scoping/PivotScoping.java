...
import org.eclipse.ocl.pivot.internal.attributes.LambdaLiteralExpAttribution;
...
{	
	public static void init() {
		...
		registry.put(PivotPackage.Literals.LAMBDA_LITERAL_EXP, LambdaLiteralExpAttribution.INSTANCE);
