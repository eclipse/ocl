...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private void installLambdaTypes() {
			...
			type.getParameterTypes().add(tp_Bag_T);
			...
			type.getParameterTypes().add(tp_Collection_T);
			type.setResultType(_Boolean);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			...
			type.getParameterTypes().add(tp_OrderedSet_T);
			type.setResultType(_Boolean);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			...
			type.getParameterTypes().add(tp_Sequence_T);
			type.setResultType(_Boolean);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			...
			type.getParameterTypes().add(tp_Set_T);
			type.setResultType(_Boolean);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			...
			type.getParameterTypes().add(tp_UniqueCollection_T);
			type.setResultType(_OclAny);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
		}
