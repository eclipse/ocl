...
public class OCLstdlibTables
{
	...
	public static class Parameters {
		...
		public static final @NonNull ParameterTypes _Collection = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Collection_T.getTypeId(), ValueId.FALSE_ID));
		...
		public static final @NonNull ParameterTypes _Collection__Bag_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Bag_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Collection_excludesAll_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__excludesAll_T2.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Collection_includesAll_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__includesAll_T2.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Collection_product_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__product_T2.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Map_excludesAll_K2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Map__excludesAll_K2.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Map_includesAll_K2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Map__includesAll_K2.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__OclAny__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.Types._OclAny.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__Set_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Set_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Collection__UniqueCollection_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._UniqueCollection_T.getTypeId(), ValueId.FALSE_ID));
		...
		public static final @NonNull ParameterTypes _Lambda_Bag_T_Boolean_NullFree = TypeUtil.createParameterTypes(OCLstdlibTables.Types._Boolean);
		public static final @NonNull ParameterTypes _Lambda_Bag_T_NullFree_Set__Bag_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Set", OCLstdlibTables.TypeParameters._Bag_T.getTypeId(), ValueId.FALSE_ID));
		...
		public static final @NonNull ParameterTypes _Lambda_OrderedSet_T_NullFree_OrderedSet = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedSet", OCLstdlibTables.TypeParameters._OrderedSet_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Lambda_Sequence_T_NullFree_OrderedSet__Sequence_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedSet", OCLstdlibTables.TypeParameters._Sequence_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _Lambda_Set_T_NullFree_Set = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Set", OCLstdlibTables.TypeParameters._Set_T.getTypeId(), ValueId.FALSE_ID));
		...
		public static final @NonNull ParameterTypes _Map__Map_excludesMap_K2_Map_excludesMap_V2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedMapType("Map", OCLstdlibTables.TypeParameters.__Map__excludesMap_K2, OCLstdlibTables.TypeParameters.__Map__excludesMap_V2));
		public static final @NonNull ParameterTypes _Map__Map_excludingMap_K2_Map_excludingMap_V2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedMapType("Map", OCLstdlibTables.TypeParameters.__Map__excludingMap_K2, OCLstdlibTables.TypeParameters.__Map__excludingMap_V2));
		public static final @NonNull ParameterTypes _Map__Map_includesMap_K2_Map_includesMap_V2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedMapType("Map", OCLstdlibTables.TypeParameters.__Map__includesMap_K2, OCLstdlibTables.TypeParameters.__Map__includesMap_V2));
		public static final @NonNull ParameterTypes _Map__Map_includingMap_K2_Map_includingMap_V2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedMapType("Map", OCLstdlibTables.TypeParameters.__Map__includingMap_K2, OCLstdlibTables.TypeParameters.__Map__includingMap_V2));
		...
		public static final @NonNull ParameterTypes _OrderedCollection__OrderedSet_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedCollection", OCLstdlibTables.TypeParameters._OrderedSet_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _OrderedCollection__Sequence_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedCollection", OCLstdlibTables.TypeParameters._Sequence_T.getTypeId(), ValueId.FALSE_ID));
		...
		public static final @NonNull ParameterTypes _UniqueCollection = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.TypeParameters._UniqueCollection_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _UniqueCollection__Collection_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.TypeParameters._Collection_T.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _UniqueCollection__OclAny__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.Types._OclAny.getTypeId(), ValueId.FALSE_ID));
		public static final @NonNull ParameterTypes _UnlimitedNatural = TypeUtil.createParameterTypes(OCLstdlibTables.Types._UnlimitedNatural);
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _Bag__closure = new ExecutorOperation("closure", Parameters._Lambda_Bag_T_NullFree_Set__Bag_T__, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__reject = new ExecutorOperation("reject", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Bag,
			10, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__select = new ExecutorOperation("select", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Collection___eq_ = new ExecutorOperation("=", Parameters._OclSelf, Types._Collection,
			1, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.oclany.OclAnyEqualOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__any = new ExecutorOperation("any", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__collect = new ExecutorOperation("collect", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__0_exists = new ExecutorOperation("exists", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
			14, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.ExistsIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__1_exists = new ExecutorOperation("exists", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__0_forAll = new ExecutorOperation("forAll", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
			17, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.ForAllIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__1_forAll = new ExecutorOperation("forAll", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__isUnique = new ExecutorOperation("isUnique", Parameters._Lambda_Bag_T_OclAny, Types._Collection,
			26, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.IsUniqueIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__iterate = new ExecutorOperation("iterate", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__one = new ExecutorOperation("one", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__reject = new ExecutorOperation("reject", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
			33, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__select = new ExecutorOperation("select", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_Bag_T_OclAny, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__closure = new ExecutorOperation("closure", Parameters._Lambda_OrderedSet_T_NullFree_OrderedSet, Types._OrderedSet,
			5, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _OrderedSet__collect = new ExecutorOperation("collect", Parameters._Lambda_Bag_T_Bag_collect_V, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_Bag_T_Bag_collect_V, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__reject = new ExecutorOperation("reject", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__select = new ExecutorOperation("select", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_Bag_T_OclAny, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _Sequence__closure = new ExecutorOperation("closure", Parameters._Lambda_Sequence_T_NullFree_OrderedSet__Sequence_T__, Types._Sequence,
			4, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Sequence__collect = new ExecutorOperation("collect", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__reject = new ExecutorOperation("reject", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__select = new ExecutorOperation("select", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_Bag_T_OclAny, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Set___eq_ = new ExecutorOperation("=", Parameters._OclSelf, Types._Set,
			2, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.oclany.OclAnyEqualOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__closure = new ExecutorOperation("closure", Parameters._Lambda_Set_T_NullFree_Set, Types._Set,
			3, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__collect = new ExecutorOperation("collect", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_Bag_T_Bag_collect_V, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__reject = new ExecutorOperation("reject", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Set,
			11, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__select = new ExecutorOperation("select", Parameters._Lambda_Bag_T_Boolean_NullFree, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_Bag_T_OclAny, Types._Set,
		...
		public static final @NonNull ExecutorOperation _UniqueCollection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_Bag_T_OclAny, Types._UniqueCollection,
		...
		public static final @NonNull ExecutorOperation _UnlimitedNatural__max = new ExecutorOperation("max", Parameters._UnlimitedNatural, Types._UnlimitedNatural,
			0, TemplateParameters.EMPTY_LIST, org.eclipse.ocl.pivot.library.numeric.UnlimitedNaturalMaxOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _UnlimitedNatural__min = new ExecutorOperation("min", Parameters._UnlimitedNatural, Types._UnlimitedNatural,
	...
	public static class FragmentOperations {
		...
		private static final @NonNull ExecutorOperation[] _Bag__Bag = {
			...
			OCLstdlibTables.Operations._Bag__closure /* closure(T[1] | Lambda(T[1]) : Set(T)[?]) */,
		...
		private static final @NonNull ExecutorOperation[] _Bag__Collection = {
			...
			OCLstdlibTables.Operations._Bag__excluding /* excluding(OclAny[?]) */,
			OCLstdlibTables.Operations._Bag__excludingAll /* excludingAll(Collection(OclAny)) */,
			OCLstdlibTables.Operations._Collection__0_exists /* exists(T[?] | Lambda(T[?]) : Boolean[1]) */,
			OCLstdlibTables.Operations._Collection__1_exists /* exists(T[?],T[?] | Lambda(T[?]) : Boolean[1]) */,
			OCLstdlibTables.Operations._Bag__flatten /* flatten<T2>() */,
			OCLstdlibTables.Operations._Collection__0_forAll /* forAll(T[?] | Lambda(T[?]) : Boolean[1]) */,
			OCLstdlibTables.Operations._Collection__1_forAll /* forAll(T[?],T[?] | Lambda(T[?]) : Boolean[1]) */,
			...
			OCLstdlibTables.Operations._Collection__iterate /* iterate<Tacc>(T[?];Tacc[?] | Lambda(T[?]) : V[?]) */,
		...
		private static final @NonNull ExecutorOperation[] _OclType__OclType = {
			OCLstdlibTables.Operations._OclType__conformsTo /* conformsTo(OclType[1]) */
		};
		...
		private static final @NonNull ExecutorOperation[] _OrderedSet__OrderedSet = {
			...
			OCLstdlibTables.Operations._OrderedSet__closure /* closure(T[1] | Lambda(T[1]) : OrderedSet<T>[?]) */,
		...
		private static final @NonNull ExecutorOperation[] _Sequence__Sequence = {
			...
			OCLstdlibTables.Operations._Sequence__closure /* closure(T[1] | Lambda(T[1]) : OrderedSet(T)[?]) */,
		...
		private static final @NonNull ExecutorOperation[] _Set__Set = {
			...
			OCLstdlibTables.Operations._Set__closure /* closure(T[1] | Lambda(T[1]) : Set<T>[?]) */,
		...
		private static final @NonNull ExecutorOperation[] _String__String = {
			OCLstdlibTables.Operations._String___add_ /* _'+'(String[1]) */,
			...
			OCLstdlibTables.Operations._String__concat /* concat(String[1]) */,
		...
		private static final @NonNull ExecutorOperation[] _UnlimitedNatural__UnlimitedNatural = {
			OCLstdlibTables.Operations._UnlimitedNatural__max /* max(UnlimitedNatural[1]) */,
			OCLstdlibTables.Operations._UnlimitedNatural__min /* min(UnlimitedNatural[1]) */,
