...
public class OCLstdlibTables
{
	...
	public static class Parameters {
		...
		public static final @NonNull ParameterTypes _Collection = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Collection_T));
		...
		public static final @NonNull ParameterTypes _Collection__Bag_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Bag_T));
		public static final @NonNull ParameterTypes _Collection__Collection_excludesAll_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__excludesAll_T2));
		public static final @NonNull ParameterTypes _Collection__Collection_includesAll_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__includesAll_T2));
		public static final @NonNull ParameterTypes _Collection__Collection_product_T2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Collection__product_T2));
		public static final @NonNull ParameterTypes _Collection__Map_excludesAll_K2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Map__excludesAll_K2));
		public static final @NonNull ParameterTypes _Collection__Map_includesAll_K2__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters.__Map__includesAll_K2));
		public static final @NonNull ParameterTypes _Collection__OclAny__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.Types._OclAny));
		public static final @NonNull ParameterTypes _Collection__Set_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._Set_T));
		public static final @NonNull ParameterTypes _Collection__UniqueCollection_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Collection", OCLstdlibTables.TypeParameters._UniqueCollection_T));
		...
		public static final @NonNull ParameterTypes _Lambda_Bag_T_Set__Bag_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Set", OCLstdlibTables.TypeParameters._Bag_T));
		...
		public static final @NonNull ParameterTypes _Lambda_OrderedSet_T_OrderedSet = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedSet", OCLstdlibTables.TypeParameters._OrderedSet_T));
		...
		public static final @NonNull ParameterTypes _Lambda_Sequence_T_OrderedSet__Sequence_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedSet", OCLstdlibTables.TypeParameters._Sequence_T));
		...
		public static final @NonNull ParameterTypes _Lambda_Set_T_Set = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("Set", OCLstdlibTables.TypeParameters._Set_T));
		...
		public static final @NonNull ParameterTypes _OrderedCollection__OrderedSet_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedCollection", OCLstdlibTables.TypeParameters._OrderedSet_T));
		public static final @NonNull ParameterTypes _OrderedCollection__Sequence_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("OrderedCollection", OCLstdlibTables.TypeParameters._Sequence_T));
		...
		public static final @NonNull ParameterTypes _UniqueCollection = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.TypeParameters._UniqueCollection_T));
		public static final @NonNull ParameterTypes _UniqueCollection__Collection_T__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.TypeParameters._Collection_T));
		public static final @NonNull ParameterTypes _UniqueCollection__OclAny__ = TypeUtil.createParameterTypes(new ExecutorSpecializedCollectionType("UniqueCollection", OCLstdlibTables.Types._OclAny));
