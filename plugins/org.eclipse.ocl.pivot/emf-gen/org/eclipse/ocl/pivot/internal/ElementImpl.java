...
public abstract class ElementImpl
	...
	public @NonNull List<Element> allOwnedElements()
	{
		...
		final @NonNull /*@NonInvalid*/ SetValue oclAsSet = OclAnyOclAsSetOperation.INSTANCE.evaluate(executor, PivotTables.SET_NF_1_1_CLSSid_Element, this);
		...
		final @NonNull /*@Thrown*/ List<Element> ECORE_closure = ((IdResolver.IdResolverExtension)idResolver).ecoreValueOfAll(Element.class, closure);
