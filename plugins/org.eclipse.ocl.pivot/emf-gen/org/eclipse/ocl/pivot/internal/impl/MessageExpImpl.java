 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.MessageExpImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.MessageExpImpl#getCalledOperation <em>Called Operation</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.MessageExpImpl#getSentSignal <em>Sent Signal</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.MessageExpImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public boolean validateTargetIsNotACollection(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
		    ...
		    try {
		        ...
		        final @Nullable /*@Thrown*/ OCLExpression target = this.getTarget();
		        if (target == null) {
		            throw new InvalidValueException("Null source for \'pivot::TypedElement::type\'");
		        }
		        final @Nullable /*@Thrown*/ Type type = target.getType();
