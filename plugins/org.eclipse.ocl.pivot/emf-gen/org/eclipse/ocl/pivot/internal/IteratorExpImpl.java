...
//		TemplateParameterSubstitutions bindings = null; //new HashMap<TemplateParameter, Type>();
	...
	public boolean validateIteratorTypeIsSourceElementType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		 ...
		 *     else
		 *       let
		 *         status : OclAny[?] = self.ownedIterators->forAll(p | ownedSource <> null implies
		            ...
		            try {
		                ...
		                try {
		                    ...
		                    if (symbol_0 == Boolean.TRUE) {
		                        ...
		                        assert ownedSource_0 != null;
		                        final @Nullable /*@Thrown*/ Type type = ownedSource_0.getType();
		                        safe_type_source = type;
		                    }
		                    final @NonNull /*@Thrown*/ CollectionType oclAsType = ClassUtil.nonNullState((CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, TYP_CollectionType_0));
		                    @SuppressWarnings("null")
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.ITERATOR_EXP___AS_TEMPLATE_PARAMETER:
				return asTemplateParameter();
			case PivotPackage.ITERATOR_EXP___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT:
				return isCompatibleWith((ParameterableElement)arguments.get(0));
			case PivotPackage.ITERATOR_EXP___IS_TEMPLATE_PARAMETER:
