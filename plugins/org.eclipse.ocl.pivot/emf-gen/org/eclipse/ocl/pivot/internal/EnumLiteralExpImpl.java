...
public class EnumLiteralExpImpl
	...
	public boolean validateTypeIsEnumerationType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		 ...
		 *     then true
		 *     else
		 *       let status : Boolean[?] = type = referredLiteral.owningEnumeration and typeValue = null
		 *       in
		...
		if (le) {
		    ...
		    try {
		        ...
		        try {
		            ...
		            final /*@Thrown*/ boolean eq = (type != null) ? (type.getTypeId() == owningEnumeration.getTypeId()) : false;
		            CAUGHT_eq = eq;
		        }
		        catch (Exception e) {
