...
public class StringLiteralExpImpl
	...
	public boolean validateTypeIsString(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		 ...
		 *     then true
		 *     else
		 *       let status : Boolean[?] = type = String and typeValue = null
		 *       in
		 *         'StringLiteralExp::TypeIsString'.logDiagnostic(self, diagnostics, context, severity, status, 0)
		 *     endif
		 */
		...
		if (le) {
		    ...
		    try {
		        ...
		        try {
		            ...
		            final /*@Thrown*/ boolean eq = (type != null) ? (type.getTypeId() == TYP_String.getTypeId()) : false;
		            CAUGHT_eq = eq;
		        }
		        catch (Exception e) {
		    ...
		    final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, PivotTables.STR_StringLiteralExp_c_c_TypeIsString, this, diagnostics, context, severity_0, CAUGHT_status, PivotTables.INT_0).booleanValue();
