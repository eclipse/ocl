...
public class PivotPackageImpl
	 ...
	 */
	@Override
	public EOperation getAnnotation__ValidateDetailNamesAreUnique__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getLiteralExp__IsNonNull()
	{
	...
	{
		return literalExpEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getCollectionItem__IsNullFree()
	{
	...
	{
		return collectionItemEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getCollectionLiteralPart__IsNullFree()
	{
	 ...
	 */
	@Override
	public EOperation getCollectionLiteralExp__ValidateCompatibleElementType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getCollectionLiteralExp__ValidateCompatibleNullFree__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getCollectionLiteralExp__ValidateCompatibleType__DiagnosticChain_Map()
	{
	...
	{
		return collectionLiteralExpEClass.getEOperations().get(7);
	}
	...
	{
		return collectionLiteralExpEClass.getEOperations().get(5);
	}
	...
	{
		return collectionLiteralExpEClass.getEOperations().get(6);
	}
	 ...
	 */
	@Override
	public EOperation getCollectionRange__IsNullFree()
	{
	...
	{
		return collectionRangeEClass.getEOperations().get(2);
	}
	 ...
	 */
	@Override
	public EOperation getExpressionInOCL__MayHaveNullType()
	{
		return expressionInOCLEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getExpressionInOCL__MayHaveOclInvalidType()
	{
		return expressionInOCLEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getVariable__ValidateCompatibleInitializerType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getIfExp__ValidateCompatibleElseType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getIfExp__ValidateCompatibleThenType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getNullLiteralExp__IsNonNull()
	{
	...
	{
		return nullLiteralExpEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getRealLiteralExp__ValidateTypeIsReal__DiagnosticChain_Map()
	{
		return realLiteralExpEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getShadowPart__ValidateCompatibleInitializerType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getStringLiteralExp__ValidateTypeIsString__DiagnosticChain_Map()
	{
		return stringLiteralExpEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getTupleLiteralPart__ValidateCompatibleInitializerType__DiagnosticChain_Map()
	{
	 ...
	 */
	@Override
	public EOperation getUnlimitedNaturalLiteralExp__ValidateTypeIsUnlimitedNatural__DiagnosticChain_Map()
	{
		return unlimitedNaturalLiteralExpEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getTypedElement__MayHaveNullType()
	{
	 ...
	 */
	@Override
	public EOperation getTypedElement__MayHaveOclInvalidType()
	{
		return typedElementEClass.getEOperations().get(2);
	}
	 ...
	 */
	@Override
	public EOperation getTypedElement__ValidateTypeIsNotNull__DiagnosticChain_Map()
	{
		return typedElementEClass.getEOperations().get(3);
	}
	 ...
	 */
	@Override
	public EOperation getTypedElement__ValidateTypeIsNotOclInvalid__DiagnosticChain_Map()
	{
		return typedElementEClass.getEOperations().get(4);
	}
	 ...
	 */
	@Override
	public EOperation getOperation__MayHaveNullType()
	{
	...
	public void createPackageContents()
	{
		...
		createEOperation(annotationEClass, ANNOTATION___VALIDATE_DETAIL_NAMES_ARE_UNIQUE__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(collectionItemEClass, COLLECTION_ITEM___IS_NULL_FREE);
		...
		createEOperation(collectionLiteralExpEClass, COLLECTION_LITERAL_EXP___VALIDATE_COMPATIBLE_ELEMENT_TYPE__DIAGNOSTICCHAIN_MAP);
		createEOperation(collectionLiteralExpEClass, COLLECTION_LITERAL_EXP___VALIDATE_COMPATIBLE_NULL_FREE__DIAGNOSTICCHAIN_MAP);
		createEOperation(collectionLiteralExpEClass, COLLECTION_LITERAL_EXP___VALIDATE_COMPATIBLE_TYPE__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(collectionLiteralPartEClass, COLLECTION_LITERAL_PART___IS_NULL_FREE);
		...
		createEOperation(collectionRangeEClass, COLLECTION_RANGE___IS_NULL_FREE);
		...
		createEOperation(expressionInOCLEClass, EXPRESSION_IN_OCL___MAY_HAVE_NULL_TYPE);
		createEOperation(expressionInOCLEClass, EXPRESSION_IN_OCL___MAY_HAVE_OCL_INVALID_TYPE);
		...
		createEOperation(literalExpEClass, LITERAL_EXP___IS_NON_NULL);
		...
		createEOperation(nullLiteralExpEClass, NULL_LITERAL_EXP___IS_NON_NULL);
		...
		createEOperation(realLiteralExpEClass, REAL_LITERAL_EXP___VALIDATE_TYPE_IS_REAL__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(shadowPartEClass, SHADOW_PART___VALIDATE_COMPATIBLE_INITIALIZER_TYPE__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(stringLiteralExpEClass, STRING_LITERAL_EXP___VALIDATE_TYPE_IS_STRING__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(tupleLiteralPartEClass, TUPLE_LITERAL_PART___VALIDATE_COMPATIBLE_INITIALIZER_TYPE__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(typedElementEClass, TYPED_ELEMENT___MAY_HAVE_NULL_TYPE);
		createEOperation(typedElementEClass, TYPED_ELEMENT___MAY_HAVE_OCL_INVALID_TYPE);
		createEOperation(typedElementEClass, TYPED_ELEMENT___VALIDATE_TYPE_IS_NOT_NULL__DIAGNOSTICCHAIN_MAP);
		createEOperation(typedElementEClass, TYPED_ELEMENT___VALIDATE_TYPE_IS_NOT_OCL_INVALID__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(unlimitedNaturalLiteralExpEClass, UNLIMITED_NATURAL_LITERAL_EXP___VALIDATE_TYPE_IS_UNLIMITED_NATURAL__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(variableEClass, VARIABLE___VALIDATE_COMPATIBLE_INITIALIZER_TYPE__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents()
	{
		...
		EOperation op = initEOperation(getAnnotation__ValidateDetailNamesAreUnique__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateDetailNamesAreUnique", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getCollectionItem__IsNullFree(), ecorePackage.getEBooleanObject(), "isNullFree", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = initEOperation(getCollectionLiteralExp__ValidateCompatibleElementType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleElementType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getCollectionLiteralExp__ValidateCompatibleNullFree__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleNullFree", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getCollectionLiteralExp__ValidateCompatibleType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEOperation(getCollectionLiteralPart__IsNullFree(), ecorePackage.getEBooleanObject(), "isNullFree", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getCollectionRange__IsNullFree(), ecorePackage.getEBooleanObject(), "isNullFree", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getExpressionInOCL__MayHaveNullType(), ecorePackage.getEBoolean(), "mayHaveNullType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEOperation(getExpressionInOCL__MayHaveOclInvalidType(), ecorePackage.getEBoolean(), "mayHaveOclInvalidType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = initEOperation(getIfExp__ValidateCompatibleThenType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleThenType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEOperation(getInvalidLiteralExp__MayHaveOclInvalidType(), ecorePackage.getEBoolean(), "mayHaveOclInvalidType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getIterateExp_OwnedResult(), this.getVariable(), null, "ownedResult", null, 1, 1, IterateExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getLiteralExp__IsNonNull(), ecorePackage.getEBooleanObject(), "isNonNull", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getNamedElement__MayHaveNullName(), ecorePackage.getEBoolean(), "mayHaveNullName", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getNullLiteralExp__IsNonNull(), ecorePackage.getEBooleanObject(), "isNonNull", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getOCLExpression__IsNonNull(), ecorePackage.getEBooleanObject(), "isNonNull", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEOperation(getOCLExpression__MayHaveNullName(), ecorePackage.getEBoolean(), "mayHaveNullName", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEOperation(getOperation__MayHaveNullType(), ecorePackage.getEBoolean(), "mayHaveNullType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = initEOperation(getRealLiteralExp__ValidateTypeIsReal__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateTypeIsReal", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getShadowPart__ValidateCompatibleInitializerType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleInitializerType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getStringLiteralExp__ValidateTypeIsString__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateTypeIsString", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getTupleLiteralPart__ValidateCompatibleInitializerType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleInitializerType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getTypedElement_IsRequired(), ecorePackage.getEBoolean(), "isRequired", "true", 1, 1, TypedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEOperation(getTypedElement__MayHaveNullType(), ecorePackage.getEBoolean(), "mayHaveNullType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEOperation(getTypedElement__MayHaveOclInvalidType(), ecorePackage.getEBoolean(), "mayHaveOclInvalidType", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = initEOperation(getTypedElement__ValidateTypeIsNotNull__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateTypeIsNotNull", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getTypedElement__ValidateTypeIsNotOclInvalid__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateTypeIsNotOclInvalid", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getUnlimitedNaturalLiteralExp__ValidateTypeIsUnlimitedNatural__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateTypeIsUnlimitedNatural", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getVariable__ValidateCompatibleInitializerType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateCompatibleInitializerType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
