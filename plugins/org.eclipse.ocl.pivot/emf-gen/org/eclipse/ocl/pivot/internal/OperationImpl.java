...
//		throw new UnsupportedOperationException();	// FIXME Eliminate this feature once Acceleo bug 349278 fixed
	...
	public boolean validateLoadableImplementation(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		 ...
		 */
		final @NonNull /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final @NonNull /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotTables.STR_Operation_c_c_LoadableImplementation);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, PivotTables.INT_0).booleanValue();
		/*@NonInvalid*/ boolean symbol_0;
		if (le) {
		    symbol_0 = ValueUtil.TRUE_VALUE;
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
	{
		if (baseClass == TypedElement.class)
		{
			...
			{
				case PivotPackage.TYPED_ELEMENT___MAY_HAVE_NULL_TYPE: return PivotPackage.OPERATION___MAY_HAVE_NULL_TYPE;
		...
		if (baseClass == ParameterableElement.class)
		{
			switch (baseOperationID)
			{
				case PivotPackage.PARAMETERABLE_ELEMENT___AS_TEMPLATE_PARAMETER: return PivotPackage.OPERATION___AS_TEMPLATE_PARAMETER;
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID)
		{
			...
			case PivotPackage.OPERATION___MAY_HAVE_OCL_INVALID_TYPE:
			...
			case PivotPackage.OPERATION___AS_TEMPLATE_PARAMETER:
