...
public class ExpressionInOCLImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.EXPRESSION_IN_OCL___AS_TEMPLATE_PARAMETER:
				return asTemplateParameter();
			case PivotPackage.EXPRESSION_IN_OCL___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT:
				return isCompatibleWith((ParameterableElement)arguments.get(0));
			case PivotPackage.EXPRESSION_IN_OCL___IS_TEMPLATE_PARAMETER:
