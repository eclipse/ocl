...
public class CollectionItemImpl
	...
	public boolean validateCompatibleItemType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		 ...
		 *     then true
		 *     else
		 *       let status : Boolean[1] = ownedItem.type.conformsTo(self.type)
		 *       in
		 *         'CollectionItem::CompatibleItemType'.logDiagnostic(self, diagnostics, context, severity, status, 0)
		 *     endif
		 */
		...
		if (le) {
		    ...
		    final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, PivotTables.STR_CollectionItem_c_c_CompatibleItemType, this, diagnostics, context, severity_0, CAUGHT_status, PivotTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.COLLECTION_ITEM___MAY_HAVE_OCL_INVALID_TYPE:
				return mayHaveOclInvalidType();
			case PivotPackage.COLLECTION_ITEM___VALIDATE_TYPE_IS_NOT_NULL__DIAGNOSTICCHAIN_MAP:
