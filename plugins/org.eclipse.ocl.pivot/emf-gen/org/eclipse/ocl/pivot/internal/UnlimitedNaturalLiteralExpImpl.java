...
public class UnlimitedNaturalLiteralExpImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.UNLIMITED_NATURAL_LITERAL_EXP___AS_TEMPLATE_PARAMETER:
				return asTemplateParameter();
			case PivotPackage.UNLIMITED_NATURAL_LITERAL_EXP___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT:
				return isCompatibleWith((ParameterableElement)arguments.get(0));
			case PivotPackage.UNLIMITED_NATURAL_LITERAL_EXP___IS_TEMPLATE_PARAMETER:
				return isTemplateParameter();
			case PivotPackage.UNLIMITED_NATURAL_LITERAL_EXP___IS_NON_NULL:
				return isNonNull();
