 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.CollectionTypeImpl#getElementType <em>Element Type</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.CollectionTypeImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.CollectionTypeImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionTypeImpl
	...
	public @NonNull DomainClass getCommonType(@NonNull IdResolver idResolver, @NonNull DomainType type) {
		...
		if (type instanceof DomainCollectionType) {
			...
			if (commonInheritance instanceof CompleteInheritanceInternal) {
