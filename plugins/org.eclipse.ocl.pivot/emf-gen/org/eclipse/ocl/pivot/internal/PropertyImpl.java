...
public class PropertyImpl
	...
	public boolean isAttribute(final Property p)
	{
		...
		final @Nullable /*@NonInvalid*/ Object container = ClassifierOclContainerOperation.INSTANCE.evaluate(executor, this);
		    ...
		    try {
		        ...
		        try {
		            ...
		            try {
		                ...
		                final @NonNull /*@Thrown*/ ExpressionInOCL oclAsType = ClassUtil.nonNullState((ExpressionInOCL)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, ownedExpression_0, TYP_ExpressionInOCL_0));
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
	{
		if (baseClass == ParameterableElement.class)
		{
			...
			{
				case PivotPackage.PARAMETERABLE_ELEMENT___AS_TEMPLATE_PARAMETER: return PivotPackage.PROPERTY___AS_TEMPLATE_PARAMETER;
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID)
		{
			...
			case PivotPackage.PROPERTY___MAY_HAVE_OCL_INVALID_TYPE:
			...
			case PivotPackage.PROPERTY___VALIDATE_TYPE_IS_NOT_OCL_INVALID__DIAGNOSTICCHAIN_MAP:
				return validateTypeIsNotOclInvalid((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case PivotPackage.PROPERTY___AS_TEMPLATE_PARAMETER:
	...
	public Object getValue(@NonNull Object objectValue) {
		...
		if (eTarget instanceof EStructuralFeature) {
			...
			Object ecoreValue = eObject.eGet(eFeature);
			return ecoreValue;
		}
