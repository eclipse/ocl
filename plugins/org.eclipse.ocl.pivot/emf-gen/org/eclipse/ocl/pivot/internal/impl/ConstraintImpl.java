 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getConstrainedElement <em>Constrained Element</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#isCallable <em>Is Callable</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getOwningState <em>Owning State</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getPostContext <em>Post Context</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getPreContext <em>Pre Context</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getRedefinedConstraint <em>Redefined Constraint</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.eclipse.ocl.pivot.internal.impl.ConstraintImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
