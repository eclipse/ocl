...
public abstract class FeatureImpl
	...
	public boolean validateTypeIsNotInvalid(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		if (diagnostics != null) {
		    ...
		    String message = StringUtil.bind(PivotMessages.ValidationConstraintIsNotSatisfied_ERROR_, new Object[]{"Feature", "TypeIsNotInvalid", EObjectValidator.getObjectLabel(this, context)});
		    diagnostics.add(new BasicDiagnostic(severity, PivotValidator.DIAGNOSTIC_SOURCE, PivotValidator.FEATURE__VALIDATE_TYPE_IS_NOT_INVALID, message, new Object [] { this }));
		}
		return false;
	}
