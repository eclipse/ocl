...
public class PivotUnqualifiedPrecedenceLookupVisitor
	extends AbstractPivotCommonLookupVisitor
{
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_PivotUnqualifiedPrecedenceLookupVisitor = PACKid_java_c_s_s_org_eclipse_ocl_pivot_util.getClassId("PivotUnqualifiedPrecedenceLookupVisitor", 0);
    ...
    public PivotUnqualifiedPrecedenceLookupVisitor(@NonNull LookupEnvironment context) {
        super(context);
    ...
    public /*@NonInvalid*/ LookupEnvironment visitLibrary(final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Library element) {
        ...
        final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<Precedence> ownedPrecedences = element.getOwnedPrecedences();
        @SuppressWarnings("null")
        final /*@Thrown*/ org.eclipse.ocl.pivot.internal.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment inner = context.addElements(ownedPrecedences);
