...
public class PivotUnqualifiedEnumerationLiteralLookupVisitor
	extends AbstractPivotCommonLookupVisitor
{
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_PivotUnqualifiedEnumerationLiteralLookupVisitor = PACKid_java_c_s_s_org_eclipse_ocl_pivot_util.getClassId("PivotUnqualifiedEnumerationLiteralLookupVisitor", 0);
    ...
    public PivotUnqualifiedEnumerationLiteralLookupVisitor(@NonNull LookupEnvironment context) {
        super(context);
     ...
     */
    @Override
    public /*@NonInvalid*/ LookupEnvironment visitEnumeration(final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Enumeration element) {
        final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<EnumerationLiteral> ownedLiterals = element.getOwnedLiterals();
        @SuppressWarnings("null")
        final /*@Thrown*/ org.eclipse.ocl.pivot.internal.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment inner = context.addElements(ownedLiterals);
