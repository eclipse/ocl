...
public class PivotExportedPackageLookupVisitor
	extends AbstractPivotCommonLookupVisitor
{
    ...
    public PivotExportedPackageLookupVisitor(@NonNull LookupEnvironment context, @NonNull Object importer) {
        super(context);
     ...
     */
    @Override
    public /*@NonInvalid*/ LookupEnvironment visitModel(final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Model element) {
