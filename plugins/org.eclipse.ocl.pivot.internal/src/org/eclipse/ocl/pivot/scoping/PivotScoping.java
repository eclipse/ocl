 ...
 *******************************************************************************/
package org.eclipse.ocl.pivot.scoping;
...
import org.eclipse.ocl.pivot.attributes.DataTypeAttribution;
import org.eclipse.ocl.pivot.attributes.EnumerationAttribution;
import org.eclipse.ocl.pivot.attributes.ExpressionInOCLAttribution;
import org.eclipse.ocl.pivot.attributes.IterateExpAttribution;
import org.eclipse.ocl.pivot.attributes.IteratorExpAttribution;
import org.eclipse.ocl.pivot.attributes.LetExpAttribution;
import org.eclipse.ocl.pivot.attributes.LibraryAttribution;
import org.eclipse.ocl.pivot.attributes.ModelAttribution;
import org.eclipse.ocl.pivot.attributes.OperationAttribution;
import org.eclipse.ocl.pivot.attributes.OperationCallExpAttribution;
import org.eclipse.ocl.pivot.attributes.PackageAttribution;
import org.eclipse.ocl.pivot.attributes.PropertyAttribution;
import org.eclipse.ocl.pivot.attributes.TemplateParameterAttribution;
import org.eclipse.ocl.pivot.attributes.VariableAttribution;
import org.eclipse.ocl.pivot.attributes.VoidTypeAttribution;
