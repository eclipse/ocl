...
public class EcoreOCLEValidator implements EValidator
{
	...
	public static final @NonNull TracingOption VALIDATE_INSTANCE = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "validate/instance");
	public static final @NonNull TracingOption VALIDATE_OPAQUE_ELEMENT = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "validate/opaqueElement");
