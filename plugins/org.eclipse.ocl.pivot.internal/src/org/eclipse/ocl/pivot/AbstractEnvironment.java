...
/*		// FIXME this is now redundant
    ...
    // implements the interface method
	@Override
	public @Nullable org.eclipse.ocl.pivot.Package getContextPackage() {
	...
	public @Nullable org.eclipse.ocl.pivot.Class getContextClassifier() {
		...
		return selfVariable != null ? (org.eclipse.ocl.pivot.Class)selfVariable.getType() : null;	// FIXME cast
	}
     ...
     */
	protected void setContextPackage(@Nullable org.eclipse.ocl.pivot.Package contextPackage) {
	...
	public void setSelfVariable(@NonNull Variable var) {
		...
		if (getContextPackage() == null) {
			org.eclipse.ocl.pivot.Class contextClassifier = getContextClassifier();
