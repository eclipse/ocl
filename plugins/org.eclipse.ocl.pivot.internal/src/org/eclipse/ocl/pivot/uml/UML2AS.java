...
{
	public static final @NonNull TracingOption ADD_ELEMENT_EXTENSION = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/addElementExtension");
	public static final @NonNull TracingOption ADD_IMPORTED_RESOURCE = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/addImportedResource");
	public static final @NonNull TracingOption ADD_PROFILE_APPLICATION = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/addProfileApplication");
	public static final @NonNull TracingOption ADD_STEREOTYPE_APPLICATION = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/addStereotypeApplication");
	public static final @NonNull TracingOption ADD_TYPE_EXTENSION = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/addTypeExtension");
	public static final @NonNull TracingOption APPLICABLE_STEREOTYPES = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/applicableStereotypes");
	public static final @NonNull TracingOption CONVERT_RESOURCE = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/convertResource");
	public static final @NonNull TracingOption TYPE_EXTENSIONS = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "uml2as/typeExtensions");
...
/*		conversion.pivotModel = metaModelManager.createModel(umlURI.lastSegment(), umlResource.getURI().toString());
	...
	{		
		...
		@Override
		public @NonNull Model getPivotModel() throws ParserException {
			Model pivotModel2 = pivotModel;
			if (pivotModel2 == null) {
				pivotModel2 = root.getPivotModel();
