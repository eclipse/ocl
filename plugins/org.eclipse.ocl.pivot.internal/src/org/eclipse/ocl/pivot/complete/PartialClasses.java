...
import org.eclipse.ocl.pivot.impl.CompleteClassImpl;
...
public class PartialClasses extends EObjectResolvingEList<org.eclipse.ocl.pivot.Class> implements ClassListeners.IClassListener
{
	...
	public static final @NonNull TracingOption PARTIAL_CLASSES = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialClasses");
//	static { PARTIAL_CLASSES.setState(true); }

	public static final @NonNull TracingOption ADD_BASE_PROPERTY = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialClasses/addBaseProperty");
	public static final @NonNull TracingOption ADD_EXTENSION_PROPERTY = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialClasses/addExtensionProperty");
	public static final @NonNull TracingOption INIT_MEMBER_OPERATIONS = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialClasses/initMemberOperations");	
	public static final @NonNull TracingOption INIT_MEMBER_PROPERTIES = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialClasses/initMemberProperties");
