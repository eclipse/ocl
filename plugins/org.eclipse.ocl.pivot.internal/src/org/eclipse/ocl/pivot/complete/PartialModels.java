...
import org.eclipse.ocl.pivot.impl.CompleteModelImpl;
...
{
	public static final @NonNull TracingOption PARTIAL_MODELS = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "partialModels");
