...
import org.eclipse.ocl.pivot.utilities.StandaloneProjectMap.DelegatedSinglePackageResource;
...
{		
	...
	public static final @NonNull TracingOption CREATE_MUTABLE_CLONE = new TracingOption(PivotInternalPlugin.PLUGIN_ID, "mm/createMutableClone");
