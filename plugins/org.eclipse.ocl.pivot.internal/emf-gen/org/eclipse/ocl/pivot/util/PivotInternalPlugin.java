...
import org.eclipse.ocl.pivot.OCLDebugOptions;
import org.eclipse.ocl.pivot.PivotStandaloneSetup;
import org.eclipse.ocl.pivot.library.StandardLibraryRegistryReader;
 ...
 * @generated
 */
public final class PivotInternalPlugin
		extends EMFPlugin {

	public static final @NonNull String PLUGIN_ID = "org.eclipse.ocl.pivot"; //$NON-NLS-1$
	...
	public static final @NonNull String COMPLETE_OCL_REGISTRY_QPID = PivotInternalPlugin.PLUGIN_ID + "." + PivotInternalPlugin.COMPLETE_OCL_REGISTRY_PID;
	 ...
	 * @generated
	 */
	public static final @NonNull PivotInternalPlugin INSTANCE = new PivotInternalPlugin();
	...
	public static String getPluginId() {
		return (getPlugin() != null)
			...
			: "org.eclipse.ocl.pivot"; // last known bundle ID //$NON-NLS-1$
	}
	...
	public static void log(int severity, int code, String message,
		...
		try {
			...
			catching(PivotInternalPlugin.class, "log", iae);//$NON-NLS-1$
		}
	}
