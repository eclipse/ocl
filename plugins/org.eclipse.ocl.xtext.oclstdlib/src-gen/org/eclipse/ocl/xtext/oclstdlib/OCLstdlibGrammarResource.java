...
public class OCLstdlibGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLstdlib
	{
		...
		private static final @NonNull ParserRule PR_FullTypeDeclarationCS = createParserRule("FullTypeDeclarationCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.TYPED_REF_CS));
		...
		private static void initParserRules() {
			...
			PR_FullTypeDeclarationCS.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_TypeLiteralWithMultiplicityCS), createGroup(createAlternatives(createRuleCall(_Base.PR_PathTypeCS), createRuleCall(PR_TypeofDeclarationCS)), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
			...
			PR_ParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS))));
			...
			PR_RestrictedKeywords.setAlternatives(createAlternatives(createKeyword("annotation"), createKeyword("conformsTo"), createKeyword("documentation"), createKeyword("extends"), createKeyword("import"), createKeyword("inv"), createKeyword("invalidating"), createKeyword("iteration"), createKeyword("left"), createKeyword("library"), createKeyword("operation"), createKeyword("package"), createKeyword("post"), createKeyword("pre"), createKeyword("precedence"), createKeyword("property"), createKeyword("right"), createKeyword("static"), createKeyword("type"), createKeyword("validating")));
			PR_SpecificationCS.setAlternatives(createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_FullTypeDeclarationCS))));
			PR_TypeofDeclarationCS.setAlternatives(createGroup(createAssignment("isTypeof", "?=", createKeyword("typeof")), createKeyword("("), createAssignment("ownedPathName", "=", createRuleCall(PR_LibPathNameCS)), createKeyword(")")));
		}
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_TypeofDeclarationCS);
	...
	private static class _EssentialOCL
	{
		...
		private static final @NonNull ParserRule PR_SimpleTypeDeclarationCS = createParserRule("SimpleTypeDeclarationCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.TYPED_REF_CS));
		...
		private static void initParserRules() {
			...
			PR_CollectionTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_CollectionTypeIdentifier)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedType", "=", createRuleCall(_OCLstdlib.PR_FullTypeDeclarationCS)), createKeyword(")")))));
			...
			PR_FullTypeDeclarationCS.setAlternatives(createAlternatives(createRuleCall(PR_TypeLiteralWithMultiplicityCS), createGroup(createRuleCall(_Base.PR_PathTypeCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
			...
			PR_MapTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Map")), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedKeyType", "=", createRuleCall(_OCLstdlib.PR_FullTypeDeclarationCS)), createKeyword(","), createAssignment("ownedValueType", "=", createRuleCall(_OCLstdlib.PR_FullTypeDeclarationCS)), createKeyword(")")))));
			...
			PR_SimpleTypeDeclarationCS.setAlternatives(createAlternatives(createRuleCall(PR_TypeLiteralCS), createRuleCall(_Base.PR_PathTypeCS)));
			...
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_OCLstdlib.PR_FullTypeDeclarationCS))));
			...
			PR_TypeExpCS.setAlternatives(createAlternatives(createRuleCall(PR_TypeNameExpCS), createRuleCall(PR_TypeLiteralWithMultiplicityCS), createRuleCall(PR_CollectionPatternCS)));
			...
			PR_TypeNameExpCS.setAlternatives(createGroup(createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedBinding", "=", createRuleCall(_Base.PR_TemplateBindingCS)), createKeyword(")"))), setCardinality("?", createGroup(createAssignment("ownedCurlyBracketedClause", "=", createRuleCall(PR_CurlyBracketedClauseCS)), setCardinality("?", createGroup(createKeyword("{"), createAssignment("ownedPatternGuard", "=", createRuleCall(PR_ExpCS)), createKeyword("}"))))), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS))))))));
			PR_TypeRefCS.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS), createRuleCall(PR_WildcardTypeRefCS)));
			...
			PR_WildcardTypeRefCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS)), createKeyword("?"), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "=", createRuleCall(_EssentialOCL.PR_SimpleTypeDeclarationCS))))));
		}
