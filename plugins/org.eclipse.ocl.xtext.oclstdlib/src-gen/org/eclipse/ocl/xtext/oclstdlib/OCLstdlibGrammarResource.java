...
public class OCLstdlibGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLstdlib
	{
		...
		private static void initParserRules() {
			PR_AccumulatorCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_ComplexTypeCS.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_TypeLiteralWithMultiplicityCS), createGroup(createAlternatives(createRuleCall(_Base.PR_PathTypeCS), createRuleCall(PR_TypeofDeclarationCS)), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
			...
			PR_ParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CollectionTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_CollectionTypeIdentifier)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedType", "=", createRuleCall(_OCLstdlib.PR_ComplexTypeCS)), createKeyword(")")))));
			...
			PR_MapTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Map")), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedKeyType", "=", createRuleCall(_OCLstdlib.PR_ComplexTypeCS)), createKeyword(","), createAssignment("ownedValueType", "=", createRuleCall(_OCLstdlib.PR_ComplexTypeCS)), createKeyword(")")))));
			...
			PR_TemplateParameterActualCS.setAlternatives(createAlternatives(createRuleCall(_OCLstdlib.PR_ComplexTypeCS), createRuleCall(_Base.PR_WildcardTypeRefCS), createRuleCall(PR_PrimitiveLiteralExpCS)));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_OCLstdlib.PR_ComplexTypeCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_OCLstdlib.PR_ComplexTypeCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TemplateParameterActualCS.setAlternatives(createAlternatives(createRuleCall(_OCLstdlib.PR_ComplexTypeCS), createRuleCall(PR_WildcardTypeRefCS)));
