...
public class OCLstdlibGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLstdlib
	{
		...
		private static void initParserRules() {
			...
			PR_AnyName.setAlternatives(createAlternatives(createRuleCall(PR_Name), createKeyword("Lambda"), createKeyword("Tuple")));
			...
			PR_TypedMultiplicityRefCS.setAlternatives(createGroup(createAlternatives(createRuleCall(_EssentialOCL.PR_TupleTypeCS), createRuleCall(PR_TypedTypeRefCS), createRuleCall(PR_LambdaTypeCS)), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
			PR_TypedRefCS.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_TupleTypeCS), createRuleCall(PR_TypedTypeRefCS), createRuleCall(PR_LambdaTypeCS)));
			PR_TypedTypeRefCS.setAlternatives(createAlternatives(createGroup(createAssignment("isTypeof", "?=", createKeyword("typeof")), createKeyword("("), createAssignment("ownedPathName", "=", createRuleCall(PR_LibPathNameCS)), createKeyword(")")), createGroup(createAssignment("ownedPathName", "=", createRuleCall(PR_LibPathNameCS)), setCardinality("?", createAssignment("ownedBinding", "=", createRuleCall(_Base.PR_TemplateBindingCS))))));
		}
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Tuple")));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createAlternatives(createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_OCLstdlib.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_OCLstdlib.PR_TypedRefCS))))), createGroup(createKeyword("super"), createAssignment("ownedSuper", "=", createRuleCall(_OCLstdlib.PR_TypedRefCS)))))));
			...
			PR_WildcardTypeRefCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS)), createKeyword("?"), setCardinality("?", createAlternatives(createGroup(createKeyword("extends"), createAssignment("ownedExtends", "=", createRuleCall(_OCLstdlib.PR_TypedRefCS))), createGroup(createKeyword("super"), createAssignment("ownedSuper", "=", createRuleCall(_OCLstdlib.PR_TypedRefCS)))))));
		}
