 ...
 *******************************************************************************/
package org.eclipse.ocl.pivot.uml.compatibility;
...
public class UML_4_2
{
	...
	static {
		...
		try {
//			Class<?> uml2EcoreConverterClass = CommonPlugin.loadClass(PivotUMLPlugin.PLUGIN_ID, "org.eclipse.uml2.uml.util.UMLUtil$UML2EcoreConverter");
			uml2EcoreConverter_getOriginalName_Method = org.eclipse.uml2.uml.util.UMLUtil.UML2EcoreConverter.class.getMethod("getOriginalName", ENamedElement.class);
