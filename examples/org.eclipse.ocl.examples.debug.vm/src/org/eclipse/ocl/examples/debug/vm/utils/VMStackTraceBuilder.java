...
public class VMStackTraceBuilder {
    ...
    public List<VMStackTraceElement> buildStackTrace() {
    	...
    	for (IVMEvaluationEnvironment<?> nextEnv = fEvalEnv; nextEnv != null; nextEnv = nextEnv.getParentEvaluationEnvironment()) {
    	...
    	@SuppressWarnings("unused")IVMEvaluationEnvironment<?> rootEnv = fEvalEnv.getRootEvaluationEnvironment();
