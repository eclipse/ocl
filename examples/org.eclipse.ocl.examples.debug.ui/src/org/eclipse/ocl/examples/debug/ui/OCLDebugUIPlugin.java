...
public class OCLDebugUIPlugin extends AbstractUIPlugin {
	...
	public static final String DEBUG_EDITOR_ID  = CompleteOCLEditor.EDITOR_ID; //$NON-NLS-1$	
	...
	protected ImageRegistry createImageRegistry() {
		...
		imageRegistry.put(OCLDebugImages.LOCAL_VARIABLE, imageDescriptor("localvar_obj.gif")); //$NON-NLS-1$		
		imageRegistry.put(OCLDebugImages.THIS_VARIABLE, imageDescriptor("thisvar_obj.gif")); //$NON-NLS-1$
		imageRegistry.put(OCLDebugImages.PREDEFINED_VARIABLE, imageDescriptor("predefvar_obj.gif")); //$NON-NLS-1$
		imageRegistry.put(OCLDebugImages.MODEL_PARAMETER, imageDescriptor("modelpar_obj.gif")); //$NON-NLS-1$
