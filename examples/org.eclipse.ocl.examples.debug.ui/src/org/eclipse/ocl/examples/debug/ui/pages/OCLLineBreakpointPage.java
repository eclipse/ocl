...
public class OCLLineBreakpointPage extends OCLBreakpointPage {
    ...
    protected void createTypeSpecificLabels(Composite parent) {
        ...
        try {
            ...
            OCLDebugUIPlugin.log(ce);
        }
        if (lineNumber.length() > 0) {
            createLabel(parent, DebugUIMessages.OCLLineBreakpointPage_LineNumber); 
    ...
    private void createConditionEditor(Composite parent) throws CoreException {
        VMLineBreakpoint breakpoint = (VMLineBreakpoint) getBreakpoint();
        String label = DebugUIMessages.OCLLineBreakpointPage_EnableCondition; 
        ...
        fSuspendWhenLabel = createLabel(conditionComposite, DebugUIMessages.OCLLineBreakpointPage_SuspendCondition); 
        fConditionIsTrue = createRadioButton(conditionComposite, DebugUIMessages.OCLLineBreakpointPage_ConditionTrue); 
        fConditionHasChanged = createRadioButton(conditionComposite, DebugUIMessages.OCLLineBreakpointPage_ConditionValueChange); 
