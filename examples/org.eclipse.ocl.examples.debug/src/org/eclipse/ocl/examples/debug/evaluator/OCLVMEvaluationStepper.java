...
public class OCLVMEvaluationStepper implements VMEvaluationStepper
{
	protected final @NonNull OCLEvaluationVisitor evaluationVisitor;
...
//		return fCurrentLocation;
	...
	public @NonNull OCLVMEvaluationEnvironment getVMEvaluationEnvironment() {
		return (OCLVMEvaluationEnvironment) executor.getEvaluationEnvironment();
	}
