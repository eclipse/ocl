...
{ 
	...
	public void launch(final ILaunchConfiguration configuration, String mode, final ILaunch launch, IProgressMonitor monitor) throws CoreException {
		...
		try {
			...
			final @SuppressWarnings("null")@NonNull URI oclURI = URI.createURI(oclName, true);
			String elementName = configuration.getAttribute(CONTEXT_URI, "");
			final @SuppressWarnings("null")@NonNull URI elementURI = URI.createURI(elementName, true);
            ...
            ShallowProcess.IRunnable r = new ShallowProcess.IRunnable() {
                ...
                public void run() throws Exception { 
        			OCLVMEnvironmentFactory envFactory = new OCLVMEnvironmentFactory(null);
