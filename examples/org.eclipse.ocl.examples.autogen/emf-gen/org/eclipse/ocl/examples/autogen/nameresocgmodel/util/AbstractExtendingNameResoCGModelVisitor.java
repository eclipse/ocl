...
/**
 * An AbstractExtendingNameResoCGModelVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractExtendingNameResoCGModelVisitor<R, C>
	...
	implements NameResoCGModelVisitor<R>
{
	 ...
	 */
	protected AbstractExtendingNameResoCGModelVisitor(@NonNull C context) {
		super(context);
	}	

	public @Nullable R visitCGAddOp(@NonNull org.eclipse.ocl.examples.autogen.nameresocgmodel.CGAddOp object) {
