...
public class AutoLookupGlobalContext extends AutoGlobalContext {

	public AutoLookupGlobalContext(@NonNull JavaCodeGenerator codeGenerator) {
		super(codeGenerator);		
		nameManager.reserveName("context", null);
		nameManager.reserveName("mmManager", null);
