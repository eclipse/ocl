...
public class ClassListeners<L extends ClassListeners.IClassListener> extends AbstractListeners<L>
{
	public static interface IClassListener extends AbstractListeners.IAbstractListener
	{
		...
		void didAddSuperClass(@NonNull org.eclipse.ocl.examples.pivot.Class partialClass);
		void didRemoveOperation(@NonNull Operation partialOperation);
		void didRemoveProperty(@NonNull Property partialProperty);
		void didRemoveSuperClass(@NonNull org.eclipse.ocl.examples.pivot.Class partialClass);
	}
	...
	public synchronized void didAddSuperClass(@NonNull org.eclipse.ocl.examples.pivot.Class partialClass) {
		boolean doFlush = false;
		for (WeakReference<L> ref : listeners) {
			L listener = ref.get();
			if (listener != null) {
	...
	public synchronized void didRemoveSuperClass(@NonNull org.eclipse.ocl.examples.pivot.Class partialClass) {
		boolean doFlush = false;
		for (WeakReference<L> ref : listeners) {
			L listener = ref.get();
			if (listener != null) {
