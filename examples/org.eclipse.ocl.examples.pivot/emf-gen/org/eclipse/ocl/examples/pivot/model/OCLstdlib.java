...
//		liveOCLstdlibs.put(this, null);
	...
	protected static class Contents extends AbstractContents
	{
		...
		protected void installOperations() {
			...
			ownedOperations = _Collection_Collection_T_1.getOwnedOperations();
			...
			ownedOperations = _UniqueCollection_UniqueCollection_T_1.getOwnedOperations();
		...
		protected void installIterations() {
			...
			ownedIterations = _Collection_Collection_T_1.getOwnedOperations();
			...
			ownedIterations = _UniqueCollection_UniqueCollection_T_1.getOwnedOperations();
		...
		protected void installProperties() {
			...
			Property property;
			ownedProperties = _Collection_Collection_T_1.getOwnedProperties();
			...
			ownedProperties = _Collection_T.getOwnedProperties();
			...
			ownedProperties = _Metaclass_T.getOwnedProperties();
