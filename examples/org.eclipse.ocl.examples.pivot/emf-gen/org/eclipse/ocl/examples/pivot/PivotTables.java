...
public class PivotTables
{
    ...
    public static final @NonNull /*@NonInvalid*/ ClassId CLSSid_WildcardType = PivotTables.PACKid_$metamodel$.getClassId("WildcardType", 0);
    ...
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass = TypeId.METACLASS.getSpecializedId(TypeId.BOOLEAN);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_4 = TypeId.METACLASS.getSpecializedId(TypeId.INTEGER);
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_WildcardType = TypeId.BAG.getSpecializedId(PivotTables.CLSSid_WildcardType);
    ...
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_0 = TypeId.METACLASS.getSpecializedId(PivotTables.CLSSid_BagType);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_1 = TypeId.METACLASS.getSpecializedId(PivotTables.CLSSid_OrderedSetType);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_2 = TypeId.METACLASS.getSpecializedId(PivotTables.CLSSid_SequenceType);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_3 = TypeId.METACLASS.getSpecializedId(PivotTables.CLSSid_SetType);
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId SET_CLSSid_ProfileApplication = TypeId.SET.getSpecializedId(PivotTables.CLSSid_ProfileApplication);
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId SET_CLSSid_TypeExtension = TypeId.SET.getSpecializedId(PivotTables.CLSSid_TypeExtension);
	...
	public static class Types {
		...
		public static final @NonNull EcoreExecutorType _TypeExtension = new EcoreExecutorType(PivotPackage.Literals.TYPE_EXTENSION, PACKAGE, 0);
	...
	public static class Fragments {
		...
		private static final @NonNull ExecutorFragment _TypeExtension__Element = new ExecutorFragment(Types._TypeExtension, PivotTables.Types._Element);
		private static final @NonNull ExecutorFragment _TypeExtension__OclAny = new ExecutorFragment(Types._TypeExtension, OCLstdlibTables.Types._OclAny);
		private static final @NonNull ExecutorFragment _TypeExtension__OclElement = new ExecutorFragment(Types._TypeExtension, OCLstdlibTables.Types._OclElement);
		private static final @NonNull ExecutorFragment _TypeExtension__TypeExtension = new ExecutorFragment(Types._TypeExtension, PivotTables.Types._TypeExtension);
		private static final @NonNull ExecutorFragment _TypeExtension__Visitable = new ExecutorFragment(Types._TypeExtension, PivotTables.Types._Visitable);
	...
	public static class Properties {
		...
		public static final @NonNull ExecutorProperty _Annotation__ownedContent = new EcoreExecutorProperty(PivotPackage.Literals.ANNOTATION__OWNED_CONTENT, Types._Annotation, 0);
		public static final @NonNull ExecutorProperty _Annotation__ownedDetail = new EcoreExecutorProperty(PivotPackage.Literals.ANNOTATION__OWNED_DETAIL, Types._Annotation, 1);
		public static final @NonNull ExecutorProperty _Annotation__reference = new EcoreExecutorProperty(PivotPackage.Literals.ANNOTATION__REFERENCE, Types._Annotation, 2);

		public static final @NonNull ExecutorProperty _AssociationClass__unownedAttribute = new EcoreExecutorProperty(PivotPackage.Literals.ASSOCIATION_CLASS__UNOWNED_ATTRIBUTE, Types._AssociationClass, 0);
		...
		public static final @NonNull ExecutorProperty _Behavior__transition = new EcoreExecutorProperty(PivotPackage.Literals.BEHAVIOR__TRANSITION, Types._Behavior, 0);
		public static final @NonNull ExecutorProperty _Behavior__Class__ownedBehavior = new ExecutorPropertyWithImplementation("Class", Types._Behavior, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CLASS__OWNED_BEHAVIOR));
		public static final @NonNull ExecutorProperty _Behavior__State__doActivity = new ExecutorPropertyWithImplementation("State", Types._Behavior, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.STATE__DO_ACTIVITY));
		public static final @NonNull ExecutorProperty _Behavior__State__entry = new ExecutorPropertyWithImplementation("State", Types._Behavior, 3, new EcoreLibraryOppositeProperty(PivotPackage.Literals.STATE__ENTRY));
		public static final @NonNull ExecutorProperty _Behavior__State__exit = new ExecutorPropertyWithImplementation("State", Types._Behavior, 4, new EcoreLibraryOppositeProperty(PivotPackage.Literals.STATE__EXIT));
		...
		public static final @NonNull ExecutorProperty _CallOperationAction__MessageExp__calledOperation = new ExecutorPropertyWithImplementation("MessageExp", Types._CallOperationAction, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.MESSAGE_EXP__CALLED_OPERATION));

		public static final @NonNull ExecutorProperty _Class__instanceClassName = new EcoreExecutorProperty(PivotPackage.Literals.CLASS__INSTANCE_CLASS_NAME, Types._Class, 0);
		...
		public static final @NonNull ExecutorProperty _CollectionLiteralPart__CollectionLiteralExp__part = new ExecutorPropertyWithImplementation("CollectionLiteralExp", Types._CollectionLiteralPart, 0, new EcoreLibraryOppositeProperty(PivotPackage.Literals.COLLECTION_LITERAL_EXP__PART));
		...
		public static final @NonNull ExecutorProperty _ConstructorPart__initExpression = new EcoreExecutorProperty(PivotPackage.Literals.CONSTRUCTOR_PART__INIT_EXPRESSION, Types._ConstructorPart, 0);
		public static final @NonNull ExecutorProperty _ConstructorPart__referredProperty = new EcoreExecutorProperty(PivotPackage.Literals.CONSTRUCTOR_PART__REFERRED_PROPERTY, Types._ConstructorPart, 1);
		public static final @NonNull ExecutorProperty _ConstructorPart__ConstructorExp__part = new ExecutorPropertyWithImplementation("ConstructorExp", Types._ConstructorPart, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CONSTRUCTOR_EXP__PART));
		...
		public static final @NonNull ExecutorProperty _Detail__value = new EcoreExecutorProperty(PivotPackage.Literals.DETAIL__VALUE, Types._Detail, 0);
		public static final @NonNull ExecutorProperty _Detail__Annotation__ownedDetail = new ExecutorPropertyWithImplementation("Annotation", Types._Detail, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ANNOTATION__OWNED_DETAIL));
		...
		public static final @NonNull ExecutorProperty _DynamicProperty__DynamicType__ownedProperty = new ExecutorPropertyWithImplementation("DynamicType", Types._DynamicProperty, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.DYNAMIC_TYPE__OWNED_PROPERTY));
		...
		public static final @NonNull ExecutorProperty _Element__comment = new EcoreExecutorProperty(PivotPackage.Literals.ELEMENT__COMMENT, Types._Element, 0);
		...
		public static final @NonNull ExecutorProperty _Element__ownedAnnotation = new EcoreExecutorProperty(PivotPackage.Literals.ELEMENT__OWNED_ANNOTATION, Types._Element, 2);
		...
		public static final @NonNull ExecutorProperty _Element__Annotation__ownedContent = new ExecutorPropertyWithImplementation("Annotation", Types._Element, 4, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ANNOTATION__OWNED_CONTENT));
		public static final @NonNull ExecutorProperty _Element__Annotation__reference = new ExecutorPropertyWithImplementation("Annotation", Types._Element, 5, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ANNOTATION__REFERENCE));
		public static final @NonNull ExecutorProperty _Element__Constraint__constrainedElement = new ExecutorPropertyWithImplementation("Constraint", Types._Element, 6, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CONSTRAINT__CONSTRAINED_ELEMENT));
		public static final @NonNull ExecutorProperty _Element__Element__ownedAnnotation = new ExecutorPropertyWithImplementation("Element", Types._Element, 7, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ELEMENT__OWNED_ANNOTATION));
		...
		public static final @NonNull ExecutorProperty _EnumerationLiteral__enumeration = new EcoreExecutorProperty(PivotPackage.Literals.ENUMERATION_LITERAL__ENUMERATION, Types._EnumerationLiteral, 0);
		...
		public static final @NonNull ExecutorProperty _Iteration__ownedIterator = new EcoreExecutorProperty(PivotPackage.Literals.ITERATION__OWNED_ITERATOR, Types._Iteration, 1);
		...
		public static final @NonNull ExecutorProperty _Namespace__ownedRule = new EcoreExecutorProperty(PivotPackage.Literals.NAMESPACE__OWNED_RULE, Types._Namespace, 0);
		...
		public static final @NonNull ExecutorProperty _OCLExpression__CallExp__source = new ExecutorPropertyWithImplementation("CallExp", Types._OCLExpression, 0, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CALL_EXP__SOURCE));
		public static final @NonNull ExecutorProperty _OCLExpression__CollectionItem__item = new ExecutorPropertyWithImplementation("CollectionItem", Types._OCLExpression, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.COLLECTION_ITEM__ITEM));
		public static final @NonNull ExecutorProperty _OCLExpression__CollectionRange__first = new ExecutorPropertyWithImplementation("CollectionRange", Types._OCLExpression, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.COLLECTION_RANGE__FIRST));
		...
		public static final @NonNull ExecutorProperty _Operation__isValidating = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__IS_VALIDATING, Types._Operation, 2);
		public static final @NonNull ExecutorProperty _Operation__ownedParameter = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__OWNED_PARAMETER, Types._Operation, 3);
		public static final @NonNull ExecutorProperty _Operation__owningClass = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__OWNING_CLASS, Types._Operation, 4);
		public static final @NonNull ExecutorProperty _Operation__postcondition = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__POSTCONDITION, Types._Operation, 5);
		public static final @NonNull ExecutorProperty _Operation__precedence = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__PRECEDENCE, Types._Operation, 6);
		public static final @NonNull ExecutorProperty _Operation__precondition = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__PRECONDITION, Types._Operation, 7);
		public static final @NonNull ExecutorProperty _Operation__raisedException = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__RAISED_EXCEPTION, Types._Operation, 8);
		public static final @NonNull ExecutorProperty _Operation__redefinedOperation = new EcoreExecutorProperty(PivotPackage.Literals.OPERATION__REDEFINED_OPERATION, Types._Operation, 9);
		public static final @NonNull ExecutorProperty _Operation__CallOperationAction__operation = new ExecutorPropertyWithImplementation("CallOperationAction", Types._Operation, 10, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CALL_OPERATION_ACTION__OPERATION));
		public static final @NonNull ExecutorProperty _Operation__MessageType__referredOperation = new ExecutorPropertyWithImplementation("MessageType", Types._Operation, 11, new EcoreLibraryOppositeProperty(PivotPackage.Literals.MESSAGE_TYPE__REFERRED_OPERATION));
		public static final @NonNull ExecutorProperty _Operation__OperationCallExp__referredOperation = new ExecutorPropertyWithImplementation("OperationCallExp", Types._Operation, 12, new EcoreLibraryOppositeProperty(PivotPackage.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION));
		public static final @NonNull ExecutorProperty _Operation__operation__redefinedOperation = new ExecutorPropertyWithImplementation("operation", Types._Operation, 13, new EcoreLibraryOppositeProperty(PivotPackage.Literals.OPERATION__REDEFINED_OPERATION));
		...
		public static final @NonNull ExecutorProperty _Parameter__operation = new EcoreExecutorProperty(PivotPackage.Literals.PARAMETER__OPERATION, Types._Parameter, 0);
		public static final @NonNull ExecutorProperty _Parameter__Iteration__ownedAccumulator = new ExecutorPropertyWithImplementation("Iteration", Types._Parameter, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ITERATION__OWNED_ACCUMULATOR));
		public static final @NonNull ExecutorProperty _Parameter__Iteration__ownedIterator = new ExecutorPropertyWithImplementation("Iteration", Types._Parameter, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ITERATION__OWNED_ITERATOR));
		public static final @NonNull ExecutorProperty _Parameter__Variable__representedParameter = new ExecutorPropertyWithImplementation("Variable", Types._Parameter, 3, new EcoreLibraryOppositeProperty(PivotPackage.Literals.VARIABLE__REPRESENTED_PARAMETER));
		...
		public static final @NonNull ExecutorProperty _Precedence__Library__ownedPrecedence = new ExecutorPropertyWithImplementation("Library", Types._Precedence, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.LIBRARY__OWNED_PRECEDENCE));
		...
		public static final @NonNull ExecutorProperty _ProfileApplication__applyingPackage = new EcoreExecutorProperty(PivotPackage.Literals.PROFILE_APPLICATION__APPLYING_PACKAGE, Types._ProfileApplication, 1);
		public static final @NonNull ExecutorProperty _ProfileApplication__isStrict = new EcoreExecutorProperty(PivotPackage.Literals.PROFILE_APPLICATION__IS_STRICT, Types._ProfileApplication, 2);
		...
		public static final @NonNull ExecutorProperty _Property__default = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__DEFAULT, Types._Property, 1);
		public static final @NonNull ExecutorProperty _Property__defaultExpression = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__DEFAULT_EXPRESSION, Types._Property, 2);
		public static final @NonNull ExecutorProperty _Property__implicit = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__IMPLICIT, Types._Property, 3);
		public static final @NonNull ExecutorProperty _Property__isComposite = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__IS_COMPOSITE, Types._Property, 4);
		public static final @NonNull ExecutorProperty _Property__isDerived = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__IS_DERIVED, Types._Property, 5);
		public static final @NonNull ExecutorProperty _Property__isID = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__IS_ID, Types._Property, 6);
		...
		public static final @NonNull ExecutorProperty _Property__owningClass = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__OWNING_CLASS, Types._Property, 14);
		public static final @NonNull ExecutorProperty _Property__redefinedProperty = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__REDEFINED_PROPERTY, Types._Property, 15);
		public static final @NonNull ExecutorProperty _Property__referredProperty = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__REFERRED_PROPERTY, Types._Property, 16);
		public static final @NonNull ExecutorProperty _Property__subsettedProperty = new EcoreExecutorProperty(PivotPackage.Literals.PROPERTY__SUBSETTED_PROPERTY, Types._Property, 17);
		public static final @NonNull ExecutorProperty _Property__ConstructorPart__referredProperty = new ExecutorPropertyWithImplementation("ConstructorPart", Types._Property, 18, new EcoreLibraryOppositeProperty(PivotPackage.Literals.CONSTRUCTOR_PART__REFERRED_PROPERTY));
		...
		public static final @NonNull ExecutorProperty _Property__Property__referredProperty = new ExecutorPropertyWithImplementation("Property", Types._Property, 23, new EcoreLibraryOppositeProperty(PivotPackage.Literals.PROPERTY__REFERRED_PROPERTY));
		public static final @NonNull ExecutorProperty _Property__PropertyCallExp__referredProperty = new ExecutorPropertyWithImplementation("PropertyCallExp", Types._Property, 24, new EcoreLibraryOppositeProperty(PivotPackage.Literals.PROPERTY_CALL_EXP__REFERRED_PROPERTY));
		public static final @NonNull ExecutorProperty _Property__property__opposite = new ExecutorPropertyWithImplementation("property", Types._Property, 25, new EcoreLibraryOppositeProperty(PivotPackage.Literals.PROPERTY__OPPOSITE));
		public static final @NonNull ExecutorProperty _Property__property__redefinedProperty = new ExecutorPropertyWithImplementation("property", Types._Property, 26, new EcoreLibraryOppositeProperty(PivotPackage.Literals.PROPERTY__REDEFINED_PROPERTY));
		...
		public static final @NonNull ExecutorProperty _Property__slot__definingProperty = new ExecutorPropertyWithImplementation("slot", Types._Property, 28, new EcoreLibraryOppositeProperty(PivotPackage.Literals.SLOT__DEFINING_PROPERTY));
		...
		public static final @NonNull ExecutorProperty _Region__state = new EcoreExecutorProperty(PivotPackage.Literals.REGION__STATE, Types._Region, 1);
		public static final @NonNull ExecutorProperty _Region__stateMachine = new EcoreExecutorProperty(PivotPackage.Literals.REGION__STATE_MACHINE, Types._Region, 2);
		...
		public static final @NonNull ExecutorProperty _State__deferrableTrigger = new EcoreExecutorProperty(PivotPackage.Literals.STATE__DEFERRABLE_TRIGGER, Types._State, 2);
		public static final @NonNull ExecutorProperty _State__doActivity = new EcoreExecutorProperty(PivotPackage.Literals.STATE__DO_ACTIVITY, Types._State, 3);
		public static final @NonNull ExecutorProperty _State__entry = new EcoreExecutorProperty(PivotPackage.Literals.STATE__ENTRY, Types._State, 4);
		public static final @NonNull ExecutorProperty _State__exit = new EcoreExecutorProperty(PivotPackage.Literals.STATE__EXIT, Types._State, 5);
		public static final @NonNull ExecutorProperty _State__isComposite = new EcoreExecutorProperty(PivotPackage.Literals.STATE__IS_COMPOSITE, Types._State, 6);
		public static final @NonNull ExecutorProperty _State__isOrthogonal = new EcoreExecutorProperty(PivotPackage.Literals.STATE__IS_ORTHOGONAL, Types._State, 7);
		public static final @NonNull ExecutorProperty _State__isSimple = new EcoreExecutorProperty(PivotPackage.Literals.STATE__IS_SIMPLE, Types._State, 8);
		public static final @NonNull ExecutorProperty _State__isSubmachineState = new EcoreExecutorProperty(PivotPackage.Literals.STATE__IS_SUBMACHINE_STATE, Types._State, 9);
		public static final @NonNull ExecutorProperty _State__redefinedState = new EcoreExecutorProperty(PivotPackage.Literals.STATE__REDEFINED_STATE, Types._State, 10);
		public static final @NonNull ExecutorProperty _State__region = new EcoreExecutorProperty(PivotPackage.Literals.STATE__REGION, Types._State, 11);
		public static final @NonNull ExecutorProperty _State__stateInvariant = new EcoreExecutorProperty(PivotPackage.Literals.STATE__STATE_INVARIANT, Types._State, 12);
		public static final @NonNull ExecutorProperty _State__submachine = new EcoreExecutorProperty(PivotPackage.Literals.STATE__SUBMACHINE, Types._State, 13);
		...
		public static final @NonNull ExecutorProperty _StateMachine__connectionPoint = new EcoreExecutorProperty(PivotPackage.Literals.STATE_MACHINE__CONNECTION_POINT, Types._StateMachine, 0);
		...
		public static final @NonNull ExecutorProperty _TemplateParameterSubstitution__owningTemplateBinding = new EcoreExecutorProperty(PivotPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION__OWNING_TEMPLATE_BINDING, Types._TemplateParameterSubstitution, 3);
		...
		public static final @NonNull ExecutorProperty _Trigger__state = new EcoreExecutorProperty(PivotPackage.Literals.TRIGGER__STATE, Types._Trigger, 0);
		public static final @NonNull ExecutorProperty _Trigger__transition = new EcoreExecutorProperty(PivotPackage.Literals.TRIGGER__TRANSITION, Types._Trigger, 1);
		...
		public static final @NonNull ExecutorProperty _TupleLiteralPart__initExpression = new EcoreExecutorProperty(PivotPackage.Literals.TUPLE_LITERAL_PART__INIT_EXPRESSION, Types._TupleLiteralPart, 0);
		public static final @NonNull ExecutorProperty _TupleLiteralPart__TupleLiteralExp__part = new ExecutorPropertyWithImplementation("TupleLiteralExp", Types._TupleLiteralPart, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.TUPLE_LITERAL_EXP__PART));
		...
		public static final @NonNull ExecutorProperty _Type__CollectionType__elementType = new ExecutorPropertyWithImplementation("CollectionType", Types._Type, 1, new EcoreLibraryOppositeProperty(PivotPackage.Literals.COLLECTION_TYPE__ELEMENT_TYPE));
		public static final @NonNull ExecutorProperty _Type__DynamicElement__metaType = new ExecutorPropertyWithImplementation("DynamicElement", Types._Type, 2, new EcoreLibraryOppositeProperty(PivotPackage.Literals.DYNAMIC_ELEMENT__META_TYPE));
		public static final @NonNull ExecutorProperty _Type__LambdaType__contextType = new ExecutorPropertyWithImplementation("LambdaType", Types._Type, 3, new EcoreLibraryOppositeProperty(PivotPackage.Literals.LAMBDA_TYPE__CONTEXT_TYPE));
		...
		public static final @NonNull ExecutorProperty _Type__TemplateParameter__lowerBound = new ExecutorPropertyWithImplementation("TemplateParameter", Types._Type, 7, new EcoreLibraryOppositeProperty(PivotPackage.Literals.TEMPLATE_PARAMETER__LOWER_BOUND));
		public static final @NonNull ExecutorProperty _Type__TemplateParameter__upperBound = new ExecutorPropertyWithImplementation("TemplateParameter", Types._Type, 8, new EcoreLibraryOppositeProperty(PivotPackage.Literals.TEMPLATE_PARAMETER__UPPER_BOUND));
		...
		public static final @NonNull ExecutorProperty _Type__operation__raisedException = new ExecutorPropertyWithImplementation("operation", Types._Type, 13, new EcoreLibraryOppositeProperty(PivotPackage.Literals.OPERATION__RAISED_EXCEPTION));
		public static final @NonNull ExecutorProperty _Type__typedElement__type = new ExecutorPropertyWithImplementation("typedElement", Types._Type, 14, new EcoreLibraryOppositeProperty(PivotPackage.Literals.TYPED_ELEMENT__TYPE));
		...
		public static final @NonNull ExecutorProperty _TypeExtension__isRequired = new EcoreExecutorProperty(PivotPackage.Literals.TYPE_EXTENSION__IS_REQUIRED, Types._TypeExtension, 0);
		...
		public static final @NonNull ExecutorProperty _ValueSpecification__owningSlot__values = new ExecutorPropertyWithImplementation("owningSlot", Types._ValueSpecification, 0, new EcoreLibraryOppositeProperty(PivotPackage.Literals.SLOT__VALUES));

		public static final @NonNull ExecutorProperty _Variable__implicit = new EcoreExecutorProperty(PivotPackage.Literals.VARIABLE__IMPLICIT, Types._Variable, 0);
		public static final @NonNull ExecutorProperty _Variable__initExpression = new EcoreExecutorProperty(PivotPackage.Literals.VARIABLE__INIT_EXPRESSION, Types._Variable, 1);
		...
		public static final @NonNull ExecutorProperty _Variable__ExpressionInOCL__contextVariable = new ExecutorPropertyWithImplementation("ExpressionInOCL", Types._Variable, 3, new EcoreLibraryOppositeProperty(PivotPackage.Literals.EXPRESSION_IN_OCL__CONTEXT_VARIABLE));
		public static final @NonNull ExecutorProperty _Variable__ExpressionInOCL__parameterVariable = new ExecutorPropertyWithImplementation("ExpressionInOCL", Types._Variable, 4, new EcoreLibraryOppositeProperty(PivotPackage.Literals.EXPRESSION_IN_OCL__PARAMETER_VARIABLE));
		public static final @NonNull ExecutorProperty _Variable__ExpressionInOCL__resultVariable = new ExecutorPropertyWithImplementation("ExpressionInOCL", Types._Variable, 5, new EcoreLibraryOppositeProperty(PivotPackage.Literals.EXPRESSION_IN_OCL__RESULT_VARIABLE));
		public static final @NonNull ExecutorProperty _Variable__IterateExp__result = new ExecutorPropertyWithImplementation("IterateExp", Types._Variable, 6, new EcoreLibraryOppositeProperty(PivotPackage.Literals.ITERATE_EXP__RESULT));
		public static final @NonNull ExecutorProperty _Variable__LetExp__variable = new ExecutorPropertyWithImplementation("LetExp", Types._Variable, 7, new EcoreLibraryOppositeProperty(PivotPackage.Literals.LET_EXP__VARIABLE));
		public static final @NonNull ExecutorProperty _Variable__LoopExp__iterator = new ExecutorPropertyWithImplementation("LoopExp", Types._Variable, 8, new EcoreLibraryOppositeProperty(PivotPackage.Literals.LOOP_EXP__ITERATOR));

		public static final @NonNull ExecutorProperty _VariableDeclaration__VariableExp__referredVariable = new ExecutorPropertyWithImplementation("VariableExp", Types._VariableDeclaration, 0, new EcoreLibraryOppositeProperty(PivotPackage.Literals.VARIABLE_EXP__REFERRED_VARIABLE));
	...
	public static class TypeFragments {
		...
		private static final @NonNull int[] __Metaclass = { 1,1,3,1,2,2,1,1 };
		...
		private static final @NonNull ExecutorFragment[] _TypeExtension =
		{
			Fragments._TypeExtension__OclAny /* 0 */,
			Fragments._TypeExtension__OclElement /* 1 */,
			Fragments._TypeExtension__Visitable /* 2 */,
			Fragments._TypeExtension__Element /* 3 */,
			Fragments._TypeExtension__TypeExtension /* 4 */
		};
		private static final @NonNull int[] __TypeExtension = { 1,1,1,1,1 };
	...
	public static class FragmentOperations {
		...
		private static final @NonNull ExecutorOperation[] _DynamicType__Class = {};
		...
		private static final @NonNull ExecutorOperation[] _DynamicType__Namespace = {};
		...
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__DynamicValueSpecification = {};
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__Nameable = {};
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__NamedElement = {};
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		...
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__ValueSpecification = {
		...
		private static final @NonNull ExecutorOperation[] _DynamicValueSpecification__Visitable = {};
		...
		private static final @NonNull ExecutorOperation[] _ElementExtension__Class = {};
		...
		private static final @NonNull ExecutorOperation[] _ElementExtension__Namespace = {};
		...
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__InstanceSpecification = {};
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__Nameable = {};
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__NamedElement = {};
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _InstanceSpecification__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		...
		private static final @NonNull ExecutorOperation[] _ProfileApplication__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _ProfileApplication__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _ProfileApplication__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		private static final @NonNull ExecutorOperation[] _ProfileApplication__Visitable = {};
		...
		private static final @NonNull ExecutorOperation[] _Slot__Slot = {};
		private static final @NonNull ExecutorOperation[] _Slot__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _Slot__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _Slot__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		private static final @NonNull ExecutorOperation[] _Slot__Visitable = {};
		...
		private static final @NonNull ExecutorOperation[] _TemplateParameter__Nameable = {};
		private static final @NonNull ExecutorOperation[] _TemplateParameter__NamedElement = {};
		...
		private static final @NonNull ExecutorOperation[] _TemplateParameter__OclType = {
			OCLstdlibTables.Operations._OclType__conformsTo /* conformsTo(OclType) */
		};
		...
		private static final @NonNull ExecutorOperation[] _TypeExtension__TypeExtension = {};
		private static final @NonNull ExecutorOperation[] _TypeExtension__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _TypeExtension__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _TypeExtension__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		private static final @NonNull ExecutorOperation[] _TypeExtension__Visitable = {};
		...
		private static final @NonNull ExecutorOperation[] _WildcardType__WildcardType = {};
		private static final @NonNull ExecutorOperation[] _WildcardType__Class = {};
		private static final @NonNull ExecutorOperation[] _WildcardType__Element = {
			PivotTables.Operations._Element__allOwnedElements /* allOwnedElements() */,
			PivotTables.Operations._Element__getValue /* getValue(Type,String) */
		};
		private static final @NonNull ExecutorOperation[] _WildcardType__Nameable = {};
		private static final @NonNull ExecutorOperation[] _WildcardType__NamedElement = {};
		private static final @NonNull ExecutorOperation[] _WildcardType__Namespace = {};
		private static final @NonNull ExecutorOperation[] _WildcardType__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(Metaclass(TT)) */,
		...
		private static final @NonNull ExecutorOperation[] _WildcardType__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */
		};
		private static final @NonNull ExecutorOperation[] _WildcardType__OclType = {
			OCLstdlibTables.Operations._OclType__conformsTo /* conformsTo(OclType) */
		};
		...
		private static final @NonNull ExecutorOperation[] _WildcardType__Visitable = {};
	...
	public static class FragmentProperties {
		...
		private static final @NonNull ExecutorProperty[] _AssociationClassCallExp = {
			...
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._OCLExpression__CallExp__source,
			PivotTables.Properties._OCLExpression__CollectionItem__item,
			PivotTables.Properties._OCLExpression__CollectionRange__first,
			PivotTables.Properties._OCLExpression__CollectionRange__last,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			...
			PivotTables.Properties._OCLExpression__LetExp__in,
			PivotTables.Properties._OCLExpression__LoopExp__body,
			PivotTables.Properties._OCLExpression__MessageExp__argument,
			PivotTables.Properties._OCLExpression__MessageExp__target,
			PivotTables.Properties._OCLExpression__NavigationCallExp__qualifier,
			PivotTables.Properties._OCLExpression__OperationCallExp__argument,
			PivotTables.Properties._OCLExpression__TupleLiteralPart__initExpression,
		...
		private static final @NonNull ExecutorProperty[] _CallOperationAction = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._CallOperationAction__MessageExp__calledOperation
		};
		...
		private static final @NonNull ExecutorProperty[] _CollectionItem = {
			...
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._CollectionLiteralPart__CollectionLiteralExp__part,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation
		};
		...
		private static final @NonNull ExecutorProperty[] _ConstructorPart = {
			...
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._ConstructorPart__ConstructorExp__part,
			PivotTables.Properties._Element__Element__ownedAnnotation
		};
		...
		private static final @NonNull ExecutorProperty[] _Detail = {
			...
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Detail__Annotation__ownedDetail,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation
		};
		...
		private static final @NonNull ExecutorProperty[] _DynamicProperty = {
			...
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._DynamicProperty__DynamicType__ownedProperty,
			PivotTables.Properties._Element__Element__ownedAnnotation
		};
		...
		private static final @NonNull ExecutorProperty[] _ExpressionInOCL = {
			...
			PivotTables.Properties._LanguageExpression__owningInstanceSpec__specification,
			PivotTables.Properties._ValueSpecification__owningSlot__values
		};
		...
		private static final @NonNull ExecutorProperty[] _FinalState = {
			...
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Namespace__Import__importedNamespace,
			PivotTables.Properties._State__State__redefinedState,
			PivotTables.Properties._State__StateExp__referredState
		};
		...
		private static final @NonNull ExecutorProperty[] _Import = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Import__Root__imports
		};

		private static final @NonNull ExecutorProperty[] _InstanceSpecification = {
			PivotTables.Properties._InstanceSpecification__classes,
			PivotTables.Properties._Element__comment,
			PivotTables.Properties._Element__extension,
			PivotTables.Properties._NamedElement__name,
		...
		private static final @NonNull ExecutorProperty[] _Iteration = {
			...
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Operation__CallOperationAction__operation,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Namespace__Constraint__context,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Namespace__Import__importedNamespace,
		...
		private static final @NonNull ExecutorProperty[] _Library = {
			...
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Namespace__Import__importedNamespace,
			PivotTables.Properties._Package__Package__importedPackage,
			PivotTables.Properties._Package__Root__ownedPackages
		};
		...
		private static final @NonNull ExecutorProperty[] _Precedence = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Precedence__Library__ownedPrecedence,
			PivotTables.Properties._Precedence__Operation__precedence
		};
		...
		private static final @NonNull ExecutorProperty[] _ProfileApplication = {
			PivotTables.Properties._ProfileApplication__appliedProfile,
			PivotTables.Properties._ProfileApplication__applyingPackage,
			PivotTables.Properties._Element__comment,
			PivotTables.Properties._Element__extension,
		...
		private static final @NonNull ExecutorProperty[] _Property = {
			...
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Property__ConstructorPart__referredProperty,
			PivotTables.Properties._Property__DynamicProperty__referredProperty,
			PivotTables.Properties._Element__Element__ownedAnnotation,
		...
		private static final @NonNull ExecutorProperty[] _Region = {
			...
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Namespace__Import__importedNamespace,
			PivotTables.Properties._Region__Region__extendedRegion
		};
		...
		private static final @NonNull ExecutorProperty[] _Root = {
			...
			PivotTables.Properties._Element__ownedAnnotation,
			PivotTables.Properties._Element__ownedComment,
			PivotTables.Properties._Root__ownedPackages,
			PivotTables.Properties._Namespace__ownedRule,
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
		...
		private static final @NonNull ExecutorProperty[] _SendSignalAction = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._SendSignalAction__MessageExp__sentSignal
		};
		...
		private static final @NonNull ExecutorProperty[] _Slot = {
			...
			PivotTables.Properties._Slot__values,
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation
		...
		private static final @NonNull ExecutorProperty[] _Stereotype = {
			...
			PivotTables.Properties._Type__extendedBys,
			PivotTables.Properties._Element__extension,
			PivotTables.Properties._Stereotype__extensionOfs,
			PivotTables.Properties._Class__instanceClassName,
			PivotTables.Properties._Class__isAbstract,
			PivotTables.Properties._Class__isActive,
			PivotTables.Properties._Class__isInterface,
		...
		private static final @NonNull ExecutorProperty[] _TemplateParameter = {
			PivotTables.Properties._Element__comment,
			PivotTables.Properties._TemplateParameter__constrainingClass,
			PivotTables.Properties._Type__extendedBys,
			PivotTables.Properties._Element__extension,
			...
			PivotTables.Properties._Element__ownedAnnotation,
			PivotTables.Properties._Element__ownedComment,
			PivotTables.Properties._TemplateParameter__owningTemplateSignature,
		...
		private static final @NonNull ExecutorProperty[] _TupleLiteralPart = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._TupleLiteralPart__TupleLiteralExp__part,
			PivotTables.Properties._VariableDeclaration__VariableExp__referredVariable
		};
		...
		private static final @NonNull ExecutorProperty[] _TypeExtension = {
			PivotTables.Properties._Element__comment,
			PivotTables.Properties._Element__extension,
			PivotTables.Properties._TypeExtension__isRequired,
			PivotTables.Properties._Element__ownedAnnotation,
			PivotTables.Properties._Element__ownedComment,
			PivotTables.Properties._TypeExtension__stereotype,
			PivotTables.Properties._TypeExtension__type,
			PivotTables.Properties._Element__Annotation__ownedContent,
			PivotTables.Properties._Element__Annotation__reference,
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation
		...
		private static final @NonNull ExecutorProperty[] _Variable = {
			...
			PivotTables.Properties._Element__Constraint__constrainedElement,
			PivotTables.Properties._Element__Element__ownedAnnotation,
			PivotTables.Properties._Variable__ExpressionInOCL__contextVariable,
			PivotTables.Properties._Variable__ExpressionInOCL__parameterVariable,
			PivotTables.Properties._Variable__ExpressionInOCL__resultVariable,
			PivotTables.Properties._Variable__IterateExp__result,
			PivotTables.Properties._Variable__LetExp__variable,
			PivotTables.Properties._Variable__LoopExp__iterator,
			PivotTables.Properties._VariableDeclaration__VariableExp__referredVariable
		};
		...
		private static final @NonNull ExecutorProperty[] _WildcardType = {
			PivotTables.Properties._Element__comment,
			PivotTables.Properties._Type__extendedBys,
			PivotTables.Properties._Element__extension,
			PivotTables.Properties._Class__instanceClassName,
