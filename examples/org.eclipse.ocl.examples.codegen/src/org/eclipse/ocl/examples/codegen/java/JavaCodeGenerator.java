...
public abstract class JavaCodeGenerator extends AbstractCodeGenerator
{
	...
	public static final @NonNull Class<?>[] knownClasses = {
		...
		org.eclipse.ocl.pivot.internal.library.executor.ExecutorSpecializedCollectionType.class,
		org.eclipse.ocl.pivot.internal.library.executor.ExecutorSpecializedMapType.class,
