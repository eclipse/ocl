...
public abstract class JavaCodeGenerator extends AbstractCodeGenerator
{
	...
	public static final @NonNull Class<?>[] knownClasses = {
		...
		org.eclipse.ocl.domain.elements.DomainTypedElement.class,
		...
		org.eclipse.ocl.domain.values.impl.InvalidValueException.class,
		org.eclipse.ocl.domain.values.util.ValuesUtil.class,
