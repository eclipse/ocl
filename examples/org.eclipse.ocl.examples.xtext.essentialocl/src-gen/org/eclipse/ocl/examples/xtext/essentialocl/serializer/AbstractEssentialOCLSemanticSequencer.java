...
public abstract class AbstractEssentialOCLSemanticSequencer extends BaseSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (ownedExpression=ExpCS_InfixExpCS_0_1_0 ownedOperator=BinaryOperatorCS ownedSuffix=SuffixExpCS)
	 */
	...
	/**
	 * Constraint:
	 *     ((ownedOperators+=UnaryOperatorCS+ ownedExpression=PrimaryExpCS) | (ownedOperators+=UnaryOperatorCS+ ownedExpression=LetExpCS))
	 */
	...
	/**
	 * Constraint:
	 *     (ownedOperators+=UnaryOperatorCS+ ownedExpression=PrimaryExpCS)
	 */
	...
	/**
	 * Constraint:
	 *     (ownedExpression=SuffixExpCS_InfixExpCS_0_1_0 ownedOperator=BinaryOperatorCS ownedSuffix=SuffixExpCS)
	 */
	protected void sequence_SuffixExpCS(EObject context, InfixExpCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
