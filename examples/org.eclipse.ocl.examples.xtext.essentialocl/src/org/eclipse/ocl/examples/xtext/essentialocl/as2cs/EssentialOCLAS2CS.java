...
import org.eclipse.ocl.examples.xtext.base.as2cs.BaseAS2CS;
...
{	
	...
	public EssentialOCLAS2CS(@NonNull Map<? extends BaseCSResource, ? extends ASResource> cs2asResourceMap, @NonNull MetaModelManager metaModelManager) {
