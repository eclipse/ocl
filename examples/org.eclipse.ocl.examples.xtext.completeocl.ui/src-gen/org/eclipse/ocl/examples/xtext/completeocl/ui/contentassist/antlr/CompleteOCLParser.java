		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedImportsAssignment_0_0(), "rule__CompleteOCLDocumentCS__OwnedImportsAssignment_0_0");
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedIncludesAssignment_0_1(), "rule__CompleteOCLDocumentCS__OwnedIncludesAssignment_0_1");
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedLibrariesAssignment_0_2(), "rule__CompleteOCLDocumentCS__OwnedLibrariesAssignment_0_2");
					...
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedPathNameAssignment_2(), "rule__ClassifierContextDeclCS__OwnedPathNameAssignment_2");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedInvariantsAssignment_3_0_1(), "rule__ClassifierContextDeclCS__OwnedInvariantsAssignment_3_0_1");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedDefinitionsAssignment_3_1(), "rule__ClassifierContextDeclCS__OwnedDefinitionsAssignment_3_1");
					...
					put(grammarAccess.getDefOperationCSAccess().getOwnedParametersAssignment_6_0(), "rule__DefOperationCS__OwnedParametersAssignment_6_0");
					put(grammarAccess.getDefOperationCSAccess().getOwnedParametersAssignment_6_1_1(), "rule__DefOperationCS__OwnedParametersAssignment_6_1_1");
					put(grammarAccess.getDefOperationCSAccess().getOwnedTypeAssignment_9(), "rule__DefOperationCS__OwnedTypeAssignment_9");
					put(grammarAccess.getDefOperationCSAccess().getOwnedSpecificationAssignment_11(), "rule__DefOperationCS__OwnedSpecificationAssignment_11");
					...
					put(grammarAccess.getIncludeCSAccess().getReferredNamespaceAssignment_1(), "rule__IncludeCS__ReferredNamespaceAssignment_1");
					put(grammarAccess.getLibraryCSAccess().getReferredPackageAssignment_1(), "rule__LibraryCS__ReferredPackageAssignment_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPathNameAssignment_1(), "rule__OperationContextDeclCS__OwnedPathNameAssignment_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedParametersAssignment_3_0(), "rule__OperationContextDeclCS__OwnedParametersAssignment_3_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedParametersAssignment_3_1_1(), "rule__OperationContextDeclCS__OwnedParametersAssignment_3_1_1");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPreconditionsAssignment_7_0_1(), "rule__OperationContextDeclCS__OwnedPreconditionsAssignment_7_0_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPostconditionsAssignment_7_1_1(), "rule__OperationContextDeclCS__OwnedPostconditionsAssignment_7_1_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedBodiesAssignment_7_2_3(), "rule__OperationContextDeclCS__OwnedBodiesAssignment_7_2_3");
					...
					put(grammarAccess.getURIPathNameCSAccess().getOwnedPathElementsAssignment_1_1_0(), "rule__URIPathNameCS__OwnedPathElementsAssignment_1_1_0");
					put(grammarAccess.getURIPathNameCSAccess().getOwnedPathElementsAssignment_1_2(), "rule__URIPathNameCS__OwnedPathElementsAssignment_1_2");
